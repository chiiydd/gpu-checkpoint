...
HOOK_C_API HOOK_DECL_EXPORT   cudaError_t cudaInitDevice(int device, unsigned int deviceFlags, unsigned int flags) {
    ...
    HOOK_CHECK(func_entry);
    return func_entry(device, deviceFlags, flags);
}
...
HOOK_C_API HOOK_DECL_EXPORT   cudaError_t cudaStreamBeginCaptureToGraph(cudaStream_t stream, cudaGraph_t graph, const cudaGraphNode_t * dependencies, const cudaGraphEdgeData * dependencyData, size_t numDependencies, enum cudaStreamCaptureMode mode) {
    ...
    HOOK_CHECK(func_entry);
    return func_entry(stream, graph, dependencies, dependencyData, numDependencies, mode);
}
...
HOOK_C_API HOOK_DECL_EXPORT   cudaError_t cudaStreamGetCaptureInfo_v3(cudaStream_t stream, enum cudaStreamCaptureStatus * captureStatus_out, unsigned long long * id_out, cudaGraph_t * graph_out, const cudaGraphNode_t * * dependencies_out, const cudaGraphEdgeData * * edgeData_out, size_t * numDependencies_out) {
    HOOK_TRACE_PROFILE("cudaStreamGetCaptureInfo_v3");
    using func_ptr =   cudaError_t (*)(cudaStream_t, enum cudaStreamCaptureStatus *, unsigned long long *, cudaGraph_t *, const cudaGraphNode_t * *, const cudaGraphEdgeData * *, size_t *);
    static auto func_entry = reinterpret_cast<func_ptr>(HOOK_CUDART_SYMBOL("cudaStreamGetCaptureInfo_v3"));
    HOOK_CHECK(func_entry);
    return func_entry(stream, captureStatus_out, id_out, graph_out, dependencies_out, edgeData_out, numDependencies_out);
}
...
// HOOK_C_API HOOK_DECL_EXPORT   cudaError_t cudaStreamUpdateCaptureDependencies_v2(cudaStream_t stream, cudaGraphNode_t * dependencies, const cudaGraphEdgeData * dependencyData, size_t numDependencies, unsigned int flags) {
//     HOOK_TRACE_PROFILE("cudaStreamUpdateCaptureDependencies_v2");
//     using func_ptr =   cudaError_t (*)(cudaStream_t, cudaGraphNode_t *, const cudaGraphEdgeData *, size_t, unsigned int);
//     static auto func_entry = reinterpret_cast<func_ptr>(HOOK_CUDART_SYMBOL("cudaStreamUpdateCaptureDependencies_v2"));
//     HOOK_CHECK(func_entry);
//     return func_entry(stream, dependencies, dependencyData, numDependencies, flags);
// }
...
HOOK_C_API HOOK_DECL_EXPORT   cudaError_t cudaLaunchKernelExC(const cudaLaunchConfig_t * config, const void * func, void * * args) {
    ...
    HOOK_CHECK(func_entry);
    return func_entry(config, func, args);
}
...
HOOK_C_API HOOK_DECL_EXPORT    cudaError_t cudaOccupancyMaxPotentialClusterSize(int * clusterSize, const void * func, const cudaLaunchConfig_t * launchConfig) {
    ...
    HOOK_CHECK(func_entry);
    return func_entry(clusterSize, func, launchConfig);
}
...
HOOK_C_API HOOK_DECL_EXPORT    cudaError_t cudaOccupancyMaxActiveClusters(int * numClusters, const void * func, const cudaLaunchConfig_t * launchConfig) {
    ...
    HOOK_CHECK(func_entry);
    return func_entry(numClusters, func, launchConfig);
}
...
// HOOK_C_API HOOK_DECL_EXPORT   cudaError_t cudaMemPrefetchAsync_v2(const void * devPtr, size_t count, struct cudaMemLocation location, unsigned int flags, cudaStream_t stream) {
//     HOOK_TRACE_PROFILE("cudaMemPrefetchAsync_v2");
//     using func_ptr =   cudaError_t (*)(const void *, size_t, struct cudaMemLocation, unsigned int, cudaStream_t);
//     static auto func_entry = reinterpret_cast<func_ptr>(HOOK_CUDART_SYMBOL("cudaMemPrefetchAsync_v2"));
//     HOOK_CHECK(func_entry);
//     return func_entry(devPtr, count, location, flags, stream);
// }
...
// HOOK_C_API HOOK_DECL_EXPORT   cudaError_t cudaMemAdvise_v2(const void * devPtr, size_t count, enum cudaMemoryAdvise advice, struct cudaMemLocation location) {
//     HOOK_TRACE_PROFILE("cudaMemAdvise_v2");
//     using func_ptr =   cudaError_t (*)(const void *, size_t, enum cudaMemoryAdvise, struct cudaMemLocation);
//     static auto func_entry = reinterpret_cast<func_ptr>(HOOK_CUDART_SYMBOL("cudaMemAdvise_v2"));
//     HOOK_CHECK(func_entry);
...
// HOOK_C_API HOOK_DECL_EXPORT   cudaError_t cudaGraphGetEdges_v2(cudaGraph_t graph, cudaGraphNode_t * from, cudaGraphNode_t * to, cudaGraphEdgeData * edgeData, size_t * numEdges) {
//     HOOK_TRACE_PROFILE("cudaGraphGetEdges_v2");
//     using func_ptr =   cudaError_t (*)(cudaGraph_t, cudaGraphNode_t *, cudaGraphNode_t *, cudaGraphEdgeData *, size_t *);
//     static auto func_entry = reinterpret_cast<func_ptr>(HOOK_CUDART_SYMBOL("cudaGraphGetEdges_v2"));
//     HOOK_CHECK(func_entry);
//     return func_entry(graph, from, to, edgeData, numEdges);
// }
...
// HOOK_C_API HOOK_DECL_EXPORT   cudaError_t cudaGraphNodeGetDependencies_v2(cudaGraphNode_t node, cudaGraphNode_t * pDependencies, cudaGraphEdgeData * edgeData, size_t * pNumDependencies) {
//     HOOK_TRACE_PROFILE("cudaGraphNodeGetDependencies_v2");
//     using func_ptr =   cudaError_t (*)(cudaGraphNode_t, cudaGraphNode_t *, cudaGraphEdgeData *, size_t *);
//     static auto func_entry = reinterpret_cast<func_ptr>(HOOK_CUDART_SYMBOL("cudaGraphNodeGetDependencies_v2"));
//     HOOK_CHECK(func_entry);
//     return func_entry(node, pDependencies, edgeData, pNumDependencies);
// }
...
// HOOK_C_API HOOK_DECL_EXPORT   cudaError_t cudaGraphNodeGetDependentNodes_v2(cudaGraphNode_t node, cudaGraphNode_t * pDependentNodes, cudaGraphEdgeData * edgeData, size_t * pNumDependentNodes) {
//     HOOK_TRACE_PROFILE("cudaGraphNodeGetDependentNodes_v2");
//     using func_ptr =   cudaError_t (*)(cudaGraphNode_t, cudaGraphNode_t *, cudaGraphEdgeData *, size_t *);
//     static auto func_entry = reinterpret_cast<func_ptr>(HOOK_CUDART_SYMBOL("cudaGraphNodeGetDependentNodes_v2"));
//     HOOK_CHECK(func_entry);
//     return func_entry(node, pDependentNodes, edgeData, pNumDependentNodes);
// }
...
// HOOK_C_API HOOK_DECL_EXPORT   cudaError_t cudaGraphAddDependencies_v2(cudaGraph_t graph, const cudaGraphNode_t * from, const cudaGraphNode_t * to, const cudaGraphEdgeData * edgeData, size_t numDependencies) {
//     HOOK_TRACE_PROFILE("cudaGraphAddDependencies_v2");
//     using func_ptr =   cudaError_t (*)(cudaGraph_t, const cudaGraphNode_t *, const cudaGraphNode_t *, const cudaGraphEdgeData *, size_t);
//     static auto func_entry = reinterpret_cast<func_ptr>(HOOK_CUDART_SYMBOL("cudaGraphAddDependencies_v2"));
//     HOOK_CHECK(func_entry);
//     return func_entry(graph, from, to, edgeData, numDependencies);
// }
...
// HOOK_C_API HOOK_DECL_EXPORT   cudaError_t cudaGraphRemoveDependencies_v2(cudaGraph_t graph, const cudaGraphNode_t * from, const cudaGraphNode_t * to, const cudaGraphEdgeData * edgeData, size_t numDependencies) {
//     HOOK_TRACE_PROFILE("cudaGraphRemoveDependencies_v2");
//     using func_ptr =   cudaError_t (*)(cudaGraph_t, const cudaGraphNode_t *, const cudaGraphNode_t *, const cudaGraphEdgeData *, size_t);
//     static auto func_entry = reinterpret_cast<func_ptr>(HOOK_CUDART_SYMBOL("cudaGraphRemoveDependencies_v2"));
//     HOOK_CHECK(func_entry);
//     return func_entry(graph, from, to, edgeData, numDependencies);
// }
...
HOOK_C_API HOOK_DECL_EXPORT   cudaError_t cudaGraphInstantiateWithParams(cudaGraphExec_t * pGraphExec, cudaGraph_t graph, cudaGraphInstantiateParams * instantiateParams) {
    ...
    HOOK_CHECK(func_entry);
    return func_entry(pGraphExec, graph, instantiateParams);
}
...
HOOK_C_API HOOK_DECL_EXPORT   cudaError_t cudaGraphExecGetFlags(cudaGraphExec_t graphExec, unsigned long long * flags) {
    ...
    HOOK_CHECK(func_entry);
    return func_entry(graphExec, flags);
}
...
// HOOK_C_API HOOK_DECL_EXPORT   cudaError_t cudaGraphAddNode_v2(cudaGraphNode_t * pGraphNode, cudaGraph_t graph, const cudaGraphNode_t * pDependencies, const cudaGraphEdgeData * dependencyData, size_t numDependencies, struct cudaGraphNodeParams * nodeParams) {
//     HOOK_TRACE_PROFILE("cudaGraphAddNode_v2");
//     using func_ptr =   cudaError_t (*)(cudaGraphNode_t *, cudaGraph_t, const cudaGraphNode_t *, const cudaGraphEdgeData *, size_t, struct cudaGraphNodeParams *);
//     static auto func_entry = reinterpret_cast<func_ptr>(HOOK_CUDART_SYMBOL("cudaGraphAddNode_v2"));
//     HOOK_CHECK(func_entry);
//     return func_entry(pGraphNode, graph, pDependencies, dependencyData, numDependencies, nodeParams);
// }
...
HOOK_C_API HOOK_DECL_EXPORT   cudaError_t cudaGraphNodeSetParams(cudaGraphNode_t node, struct cudaGraphNodeParams * nodeParams) {
    ...
    HOOK_CHECK(func_entry);
    return func_entry(node, nodeParams);
}
...
HOOK_C_API HOOK_DECL_EXPORT   cudaError_t cudaGraphExecNodeSetParams(cudaGraphExec_t graphExec, cudaGraphNode_t node, struct cudaGraphNodeParams * nodeParams) {
    ...
    HOOK_CHECK(func_entry);
    return func_entry(graphExec, node, nodeParams);
}
...
HOOK_C_API HOOK_DECL_EXPORT   cudaError_t cudaGraphConditionalHandleCreate(cudaGraphConditionalHandle * pHandle_out, cudaGraph_t graph, unsigned int defaultLaunchValue, unsigned int flags) {
    ...
    HOOK_CHECK(func_entry);
    return func_entry(pHandle_out, graph, defaultLaunchValue, flags);
}
...
HOOK_C_API HOOK_DECL_EXPORT   cudaError_t cudaGetDriverEntryPoint(const char * symbol, void * * funcPtr, unsigned long long flags, enum cudaDriverEntryPointQueryResult * driverStatus) {
    ...
    HOOK_CHECK(func_entry);
    return func_entry(symbol, funcPtr, flags, driverStatus);
}
...
HOOK_C_API HOOK_DECL_EXPORT   cudaError_t cudaGetKernel(cudaKernel_t * kernelPtr, const void * entryFuncAddr) {
    ...
    HOOK_CHECK(func_entry);
    return func_entry(kernelPtr, entryFuncAddr);
}
...
HOOK_C_API HOOK_DECL_EXPORT   cudaError_t cudaStreamGetCaptureInfo_ptsz(cudaStream_t stream, enum cudaStreamCaptureStatus * captureStatus_out, unsigned long long * id_out) {
    ...
    HOOK_CHECK(func_entry);
    return func_entry(stream, captureStatus_out, id_out);
}
