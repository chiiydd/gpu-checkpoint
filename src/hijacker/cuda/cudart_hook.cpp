...
HOOK_C_API HOOK_DECL_EXPORT cudaError_t cudaDeviceSetLimit(enum cudaLimit limit, size_t value) {
    ...
    HOOK_CHECK(func_entry);
    cudaError_t result=func_entry(limit, value);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT  cudaError_t cudaDeviceGetLimit(size_t * pValue, enum cudaLimit limit) {
    ...
    HOOK_CHECK(func_entry);
     cudaError_t result=func_entry(pValue, limit);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT  cudaError_t cudaDeviceGetTexture1DLinearMaxWidth(size_t * maxWidthInElements, const struct cudaChannelFormatDesc * fmtDesc, int device) {
    ...
    HOOK_CHECK(func_entry);
     cudaError_t result=func_entry(maxWidthInElements, fmtDesc, device);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT  cudaError_t cudaDeviceGetCacheConfig(enum cudaFuncCache * pCacheConfig) {
    ...
    HOOK_CHECK(func_entry);
     cudaError_t result=func_entry(pCacheConfig);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT  cudaError_t cudaDeviceGetStreamPriorityRange(int * leastPriority, int * greatestPriority) {
    ...
    HOOK_CHECK(func_entry);
     cudaError_t result=func_entry(leastPriority, greatestPriority);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT cudaError_t cudaDeviceSetCacheConfig(enum cudaFuncCache cacheConfig) {
    ...
    HOOK_CHECK(func_entry);
    cudaError_t result=func_entry(cacheConfig);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT cudaError_t cudaDeviceGetByPCIBusId(int * device, const char * pciBusId) {
    ...
    HOOK_CHECK(func_entry);
    cudaError_t result=func_entry(device, pciBusId);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT cudaError_t cudaDeviceGetPCIBusId(char * pciBusId, int len, int device) {
    ...
    HOOK_CHECK(func_entry);
    cudaError_t result=func_entry(pciBusId, len, device);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT cudaError_t cudaIpcGetEventHandle(cudaIpcEventHandle_t * handle, cudaEvent_t event) {
    ...
    HOOK_CHECK(func_entry);
    cudaError_t result=func_entry(handle, event);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT cudaError_t cudaIpcOpenEventHandle(cudaEvent_t * event, cudaIpcEventHandle_t handle) {
    ...
    HOOK_CHECK(func_entry);
    cudaError_t result=func_entry(event, handle);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT cudaError_t cudaIpcGetMemHandle(cudaIpcMemHandle_t * handle, void * devPtr) {
    ...
    HOOK_CHECK(func_entry);
    cudaError_t result=func_entry(handle, devPtr);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT cudaError_t cudaIpcOpenMemHandle(void * * devPtr, cudaIpcMemHandle_t handle, unsigned int flags) {
    ...
    HOOK_CHECK(func_entry);
    cudaError_t result=func_entry(devPtr, handle, flags);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT cudaError_t cudaIpcCloseMemHandle(void * devPtr) {
    ...
    HOOK_CHECK(func_entry);
    cudaError_t result=func_entry(devPtr);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT cudaError_t cudaDeviceFlushGPUDirectRDMAWrites(enum cudaFlushGPUDirectRDMAWritesTarget target, enum cudaFlushGPUDirectRDMAWritesScope scope) {
    ...
    HOOK_CHECK(func_entry);
    cudaError_t result=func_entry(target, scope);
    RESULT_CHECK(result);
    return result;
}

HOOK_C_API HOOK_DECL_EXPORT cudaError_t cudaDeviceRegisterAsyncNotification(int device, cudaAsyncCallback callbackFunc, void * userData, cudaAsyncCallbackHandle_t * callback) {
    HOOK_TRACE_PROFILE("cudaDeviceRegisterAsyncNotification");
    using func_ptr = cudaError_t (*)(int, cudaAsyncCallback, void *, cudaAsyncCallbackHandle_t *);
    static auto func_entry = reinterpret_cast<func_ptr>(HOOK_CUDART_SYMBOL("cudaDeviceRegisterAsyncNotification"));
    HOOK_CHECK(func_entry);
    cudaError_t result=func_entry(device, callbackFunc, userData, callback);
    RESULT_CHECK(result);
    return result;
}

HOOK_C_API HOOK_DECL_EXPORT cudaError_t cudaDeviceUnregisterAsyncNotification(int device, cudaAsyncCallbackHandle_t callback) {
    HOOK_TRACE_PROFILE("cudaDeviceUnregisterAsyncNotification");
    using func_ptr = cudaError_t (*)(int, cudaAsyncCallbackHandle_t);
    static auto func_entry = reinterpret_cast<func_ptr>(HOOK_CUDART_SYMBOL("cudaDeviceUnregisterAsyncNotification"));
    HOOK_CHECK(func_entry);
    cudaError_t result=func_entry(device, callback);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT   cudaError_t cudaDeviceGetSharedMemConfig(enum cudaSharedMemConfig * pConfig) {
    ...
    HOOK_CHECK(func_entry);
      cudaError_t result=func_entry(pConfig);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT  cudaError_t cudaDeviceSetSharedMemConfig(enum cudaSharedMemConfig config) {
    ...
    HOOK_CHECK(func_entry);
     cudaError_t result=func_entry(config);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT  const char * cudaGetErrorName(cudaError_t error) {
    ...
    HOOK_CHECK(func_entry);
     const char * result=func_entry(error);
    // RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT  cudaError_t cudaGetDeviceCount(int * count) {
    ...
    HOOK_CHECK(func_entry);
     cudaError_t result=func_entry(count);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT  cudaError_t cudaGetDeviceProperties(struct cudaDeviceProp * prop, int device) {
    ...
    HOOK_CHECK(func_entry);
     cudaError_t result=func_entry(prop, device);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT  cudaError_t cudaDeviceGetAttribute(int * value, enum cudaDeviceAttr attr, int device) {
    ...
    HOOK_CHECK(func_entry);
     cudaError_t result=func_entry(value, attr, device);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT cudaError_t cudaDeviceGetDefaultMemPool(cudaMemPool_t * memPool, int device) {
    ...
    HOOK_CHECK(func_entry);
    cudaError_t result=func_entry(memPool, device);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT cudaError_t cudaDeviceSetMemPool(int device, cudaMemPool_t memPool) {
    ...
    HOOK_CHECK(func_entry);
    cudaError_t result=func_entry(device, memPool);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT cudaError_t cudaDeviceGetNvSciSyncAttributes(void * nvSciSyncAttrList, int device, int flags) {
    ...
    HOOK_CHECK(func_entry);
    cudaError_t result=func_entry(nvSciSyncAttrList, device, flags);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT  cudaError_t cudaDeviceGetP2PAttribute(int * value, enum cudaDeviceP2PAttr attr, int srcDevice, int dstDevice) {
    ...
    HOOK_CHECK(func_entry);
     cudaError_t result=func_entry(value, attr, srcDevice, dstDevice);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT cudaError_t cudaChooseDevice(int * device, const struct cudaDeviceProp * prop) {
    ...
    HOOK_CHECK(func_entry);
    cudaError_t result=func_entry(device, prop);
    RESULT_CHECK(result);
    return result;
}

HOOK_C_API HOOK_DECL_EXPORT cudaError_t cudaInitDevice(int device, unsigned int deviceFlags, unsigned int flags) {
    HOOK_TRACE_PROFILE("cudaInitDevice");
    using func_ptr = cudaError_t (*)(int, unsigned int, unsigned int);
    static auto func_entry = reinterpret_cast<func_ptr>(HOOK_CUDART_SYMBOL("cudaInitDevice"));
    HOOK_CHECK(func_entry);
    cudaError_t result=func_entry(device, deviceFlags, flags);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT cudaError_t cudaSetDevice(int device) {
    ...
    HOOK_CHECK(func_entry);
    cudaError_t result=func_entry(device);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT cudaError_t cudaSetValidDevices(int * device_arr, int len) {
    ...
    HOOK_CHECK(func_entry);
    cudaError_t result=func_entry(device_arr, len);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT cudaError_t cudaSetDeviceFlags(unsigned int flags) {
    ...
    HOOK_CHECK(func_entry);
    cudaError_t result=func_entry(flags);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT cudaError_t cudaStreamCreate(cudaStream_t * pStream) {
    ...
    HOOK_CHECK(func_entry);
    cudaError_t result=func_entry(pStream);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT  cudaError_t cudaStreamCreateWithFlags(cudaStream_t * pStream, unsigned int flags) {
    ...
    HOOK_CHECK(func_entry);
     cudaError_t result=func_entry(pStream, flags);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT  cudaError_t cudaStreamCreateWithPriority(cudaStream_t * pStream, unsigned int flags, int priority) {
    ...
    HOOK_CHECK(func_entry);
     cudaError_t result=func_entry(pStream, flags, priority);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT  cudaError_t cudaStreamGetPriority(cudaStream_t hStream, int * priority) {
    ...
    HOOK_CHECK(func_entry);
     cudaError_t result=func_entry(hStream, priority);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT  cudaError_t cudaStreamGetFlags(cudaStream_t hStream, unsigned int * flags) {
    ...
    HOOK_CHECK(func_entry);
     cudaError_t result=func_entry(hStream, flags);
    RESULT_CHECK(result);
    return result;
}

HOOK_C_API HOOK_DECL_EXPORT  cudaError_t cudaStreamGetId(cudaStream_t hStream, unsigned long long * streamId) {
    HOOK_TRACE_PROFILE("cudaStreamGetId");
    using func_ptr =  cudaError_t (*)(cudaStream_t, unsigned long long *);
    static auto func_entry = reinterpret_cast<func_ptr>(HOOK_CUDART_SYMBOL("cudaStreamGetId"));
    HOOK_CHECK(func_entry);
     cudaError_t result=func_entry(hStream, streamId);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT  cudaError_t cudaStreamCopyAttributes(cudaStream_t dst, cudaStream_t src) {
    ...
    HOOK_CHECK(func_entry);
     cudaError_t result=func_entry(dst, src);
    RESULT_CHECK(result);
    return result;
}

HOOK_C_API HOOK_DECL_EXPORT  cudaError_t cudaStreamGetAttribute(cudaStream_t hStream, cudaStreamAttrID attr, cudaStreamAttrValue * value_out) {
    HOOK_TRACE_PROFILE("cudaStreamGetAttribute");
    using func_ptr =  cudaError_t (*)(cudaStream_t, cudaStreamAttrID, cudaStreamAttrValue *);
    static auto func_entry = reinterpret_cast<func_ptr>(HOOK_CUDART_SYMBOL("cudaStreamGetAttribute"));
    HOOK_CHECK(func_entry);
     cudaError_t result=func_entry(hStream, attr, value_out);
    RESULT_CHECK(result);
    return result;
}

HOOK_C_API HOOK_DECL_EXPORT  cudaError_t cudaStreamSetAttribute(cudaStream_t hStream, cudaStreamAttrID attr, const cudaStreamAttrValue * value) {
    HOOK_TRACE_PROFILE("cudaStreamSetAttribute");
    using func_ptr =  cudaError_t (*)(cudaStream_t, cudaStreamAttrID, const cudaStreamAttrValue *);
    static auto func_entry = reinterpret_cast<func_ptr>(HOOK_CUDART_SYMBOL("cudaStreamSetAttribute"));
    HOOK_CHECK(func_entry);
     cudaError_t result=func_entry(hStream, attr, value);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT  cudaError_t cudaStreamDestroy(cudaStream_t stream) {
    ...
    HOOK_CHECK(func_entry);
     cudaError_t result=func_entry(stream);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT  cudaError_t cudaStreamWaitEvent(cudaStream_t stream, cudaEvent_t event, unsigned int flags) {
    ...
    HOOK_CHECK(func_entry);
     cudaError_t result=func_entry(stream, event, flags);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT cudaError_t cudaStreamAddCallback(cudaStream_t stream, cudaStreamCallback_t callback, void * userData, unsigned int flags) {
    ...
    HOOK_CHECK(func_entry);
    cudaError_t result=func_entry(stream, callback, userData, flags);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT  cudaError_t cudaStreamAttachMemAsync(cudaStream_t stream, void * devPtr, size_t length, unsigned int flags) {
    ...
    HOOK_CHECK(func_entry);
     cudaError_t result=func_entry(stream, devPtr, length, flags);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT cudaError_t cudaStreamBeginCapture(cudaStream_t stream, enum cudaStreamCaptureMode mode) {
    ...
    HOOK_CHECK(func_entry);
    cudaError_t result=func_entry(stream, mode);
    RESULT_CHECK(result);
    return result;
}

HOOK_C_API HOOK_DECL_EXPORT cudaError_t cudaStreamBeginCaptureToGraph(cudaStream_t stream, cudaGraph_t graph, const cudaGraphNode_t * dependencies, const cudaGraphEdgeData * dependencyData, size_t numDependencies, enum cudaStreamCaptureMode mode) {
    HOOK_TRACE_PROFILE("cudaStreamBeginCaptureToGraph");
    using func_ptr = cudaError_t (*)(cudaStream_t, cudaGraph_t, const cudaGraphNode_t *, const cudaGraphEdgeData *, size_t, enum cudaStreamCaptureMode);
    static auto func_entry = reinterpret_cast<func_ptr>(HOOK_CUDART_SYMBOL("cudaStreamBeginCaptureToGraph"));
    HOOK_CHECK(func_entry);
    cudaError_t result=func_entry(stream, graph, dependencies, dependencyData, numDependencies, mode);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT cudaError_t cudaThreadExchangeStreamCaptureMode(enum cudaStreamCaptureMode * mode) {
    ...
    HOOK_CHECK(func_entry);
    cudaError_t result=func_entry(mode);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT cudaError_t cudaStreamEndCapture(cudaStream_t stream, cudaGraph_t * pGraph) {
    ...
    HOOK_CHECK(func_entry);
    cudaError_t result=func_entry(stream, pGraph);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT cudaError_t cudaStreamIsCapturing(cudaStream_t stream, enum cudaStreamCaptureStatus * pCaptureStatus) {
    ...
    HOOK_CHECK(func_entry);
    cudaError_t result=func_entry(stream, pCaptureStatus);
    RESULT_CHECK(result);
    return result;
}

HOOK_C_API HOOK_DECL_EXPORT cudaError_t cudaStreamGetCaptureInfo(cudaStream_t stream, enum cudaStreamCaptureStatus * captureStatus_out, unsigned long long * id_out, cudaGraph_t * graph_out, const cudaGraphNode_t * * dependencies_out, size_t * numDependencies_out) {
    ...
    HOOK_CHECK(func_entry);
    cudaError_t result=func_entry(stream, captureStatus_out, id_out, graph_out, dependencies_out, numDependencies_out);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT cudaError_t cudaStreamUpdateCaptureDependencies(cudaStream_t stream, cudaGraphNode_t * dependencies, size_t numDependencies, unsigned int flags) {
    ...
    HOOK_CHECK(func_entry);
    cudaError_t result=func_entry(stream, dependencies, numDependencies, flags);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT cudaError_t cudaEventCreate(cudaEvent_t * event) {
    ...
    HOOK_CHECK(func_entry);
    cudaError_t result=func_entry(event);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT  cudaError_t cudaEventCreateWithFlags(cudaEvent_t * event, unsigned int flags) {
    ...
    HOOK_CHECK(func_entry);
     cudaError_t result=func_entry(event, flags);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT  cudaError_t cudaEventRecord(cudaEvent_t event, cudaStream_t stream) {
    ...
    HOOK_CHECK(func_entry);
     cudaError_t result=func_entry(event, stream);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT  cudaError_t cudaEventRecordWithFlags(cudaEvent_t event, cudaStream_t stream, unsigned int flags) {
    ...
    HOOK_CHECK(func_entry);
     cudaError_t result=func_entry(event, stream, flags);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT cudaError_t cudaEventElapsedTime(float * ms, cudaEvent_t start, cudaEvent_t end) {
    ...
    HOOK_CHECK(func_entry);
    cudaError_t result=func_entry(ms, start, end);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT cudaError_t cudaImportExternalMemory(cudaExternalMemory_t * extMem_out, const struct cudaExternalMemoryHandleDesc * memHandleDesc) {
    ...
    HOOK_CHECK(func_entry);
    cudaError_t result=func_entry(extMem_out, memHandleDesc);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT cudaError_t cudaExternalMemoryGetMappedBuffer(void * * devPtr, cudaExternalMemory_t extMem, const struct cudaExternalMemoryBufferDesc * bufferDesc) {
    ...
    HOOK_CHECK(func_entry);
    cudaError_t result=func_entry(devPtr, extMem, bufferDesc);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT cudaError_t cudaExternalMemoryGetMappedMipmappedArray(cudaMipmappedArray_t * mipmap, cudaExternalMemory_t extMem, const struct cudaExternalMemoryMipmappedArrayDesc * mipmapDesc) {
    ...
    HOOK_CHECK(func_entry);
    cudaError_t result=func_entry(mipmap, extMem, mipmapDesc);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT cudaError_t cudaDestroyExternalMemory(cudaExternalMemory_t extMem) {
    ...
    HOOK_CHECK(func_entry);
    cudaError_t result=func_entry(extMem);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT cudaError_t cudaImportExternalSemaphore(cudaExternalSemaphore_t * extSem_out, const struct cudaExternalSemaphoreHandleDesc * semHandleDesc) {
    ...
    HOOK_CHECK(func_entry);
    cudaError_t result=func_entry(extSem_out, semHandleDesc);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT cudaError_t cudaSignalExternalSemaphoresAsync(const cudaExternalSemaphore_t * extSemArray, const struct cudaExternalSemaphoreSignalParams * paramsArray, unsigned int numExtSems, cudaStream_t stream) {
    ...
    HOOK_CHECK(func_entry);
    cudaError_t result=func_entry(extSemArray, paramsArray, numExtSems, stream);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT cudaError_t cudaDestroyExternalSemaphore(cudaExternalSemaphore_t extSem) {
    ...
    HOOK_CHECK(func_entry);
    cudaError_t result=func_entry(extSem);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT cudaError_t cudaLaunchKernel(const void * func, dim3 gridDim, dim3 blockDim, void * * args, size_t sharedMem, cudaStream_t stream) {
    ...
    HOOK_CHECK(func_entry);
    cudaError_t result=func_entry(func, gridDim, blockDim, args, sharedMem, stream);
    RESULT_CHECK(result);
    return result;
}

HOOK_C_API HOOK_DECL_EXPORT cudaError_t cudaLaunchKernelExC(const cudaLaunchConfig_t * config, const void * func, void * * args) {
    HOOK_TRACE_PROFILE("cudaLaunchKernelExC");
    using func_ptr = cudaError_t (*)(const cudaLaunchConfig_t *, const void *, void * *);
    static auto func_entry = reinterpret_cast<func_ptr>(HOOK_CUDART_SYMBOL("cudaLaunchKernelExC"));
    HOOK_CHECK(func_entry);
    cudaError_t result=func_entry(config, func, args);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT  cudaError_t cudaLaunchCooperativeKernelMultiDevice(struct cudaLaunchParams * launchParamsList, unsigned int numDevices, unsigned int flags) {
    ...
    HOOK_CHECK(func_entry);
     cudaError_t result=func_entry(launchParamsList, numDevices, flags);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT cudaError_t cudaFuncSetCacheConfig(const void * func, enum cudaFuncCache cacheConfig) {
    ...
    HOOK_CHECK(func_entry);
    cudaError_t result=func_entry(func, cacheConfig);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT  cudaError_t cudaFuncGetAttributes(struct cudaFuncAttributes * attr, const void * func) {
    ...
    HOOK_CHECK(func_entry);
     cudaError_t result=func_entry(attr, func);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT  cudaError_t cudaFuncSetAttribute(const void * func, enum cudaFuncAttribute attr, int value) {
    ...
    HOOK_CHECK(func_entry);
     cudaError_t result=func_entry(func, attr, value);
    RESULT_CHECK(result);
    return result;
}

HOOK_C_API HOOK_DECL_EXPORT  cudaError_t cudaFuncGetName(const char * * name, const void * func) {
    HOOK_TRACE_PROFILE("cudaFuncGetName");
    using func_ptr =  cudaError_t (*)(const char * *, const void *);
    static auto func_entry = reinterpret_cast<func_ptr>(HOOK_CUDART_SYMBOL("cudaFuncGetName"));
    HOOK_CHECK(func_entry);
     cudaError_t result=func_entry(name, func);
    RESULT_CHECK(result);
    return result;
}

HOOK_C_API HOOK_DECL_EXPORT  cudaError_t cudaFuncGetParamInfo(const void * func, size_t paramIndex, size_t * paramOffset, size_t * paramSize) {
    HOOK_TRACE_PROFILE("cudaFuncGetParamInfo");
    using func_ptr =  cudaError_t (*)(const void *, size_t, size_t *, size_t *);
    static auto func_entry = reinterpret_cast<func_ptr>(HOOK_CUDART_SYMBOL("cudaFuncGetParamInfo"));
    HOOK_CHECK(func_entry);
     cudaError_t result=func_entry(func, paramIndex, paramOffset, paramSize);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT  cudaError_t cudaSetDoubleForDevice(double * d) {
    ...
    HOOK_CHECK(func_entry);
     cudaError_t result=func_entry(d);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT cudaError_t cudaLaunchHostFunc(cudaStream_t stream, cudaHostFn_t fn, void * userData) {
    ...
    HOOK_CHECK(func_entry);
    cudaError_t result=func_entry(stream, fn, userData);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT  cudaError_t cudaFuncSetSharedMemConfig(const void * func, enum cudaSharedMemConfig config) {
    ...
    HOOK_CHECK(func_entry);
     cudaError_t result=func_entry(func, config);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT  cudaError_t cudaOccupancyMaxActiveBlocksPerMultiprocessor(int * numBlocks, const void * func, int blockSize, size_t dynamicSMemSize) {
    ...
    HOOK_CHECK(func_entry);
     cudaError_t result=func_entry(numBlocks, func, blockSize, dynamicSMemSize);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT  cudaError_t cudaOccupancyAvailableDynamicSMemPerBlock(size_t * dynamicSmemSize, const void * func, int numBlocks, int blockSize) {
    ...
    HOOK_CHECK(func_entry);
     cudaError_t result=func_entry(dynamicSmemSize, func, numBlocks, blockSize);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT  cudaError_t cudaOccupancyMaxActiveBlocksPerMultiprocessorWithFlags(int * numBlocks, const void * func, int blockSize, size_t dynamicSMemSize, unsigned int flags) {
    ...
    HOOK_CHECK(func_entry);
     cudaError_t result=func_entry(numBlocks, func, blockSize, dynamicSMemSize, flags);
    RESULT_CHECK(result);
    return result;
}

HOOK_C_API HOOK_DECL_EXPORT  cudaError_t cudaOccupancyMaxPotentialClusterSize(int * clusterSize, const void * func, const cudaLaunchConfig_t * launchConfig) {
    HOOK_TRACE_PROFILE("cudaOccupancyMaxPotentialClusterSize");
    using func_ptr =  cudaError_t (*)(int *, const void *, const cudaLaunchConfig_t *);
    static auto func_entry = reinterpret_cast<func_ptr>(HOOK_CUDART_SYMBOL("cudaOccupancyMaxPotentialClusterSize"));
    HOOK_CHECK(func_entry);
     cudaError_t result=func_entry(clusterSize, func, launchConfig);
    RESULT_CHECK(result);
    return result;
}

HOOK_C_API HOOK_DECL_EXPORT  cudaError_t cudaOccupancyMaxActiveClusters(int * numClusters, const void * func, const cudaLaunchConfig_t * launchConfig) {
    HOOK_TRACE_PROFILE("cudaOccupancyMaxActiveClusters");
    using func_ptr =  cudaError_t (*)(int *, const void *, const cudaLaunchConfig_t *);
    static auto func_entry = reinterpret_cast<func_ptr>(HOOK_CUDART_SYMBOL("cudaOccupancyMaxActiveClusters"));
    HOOK_CHECK(func_entry);
     cudaError_t result=func_entry(numClusters, func, launchConfig);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT  cudaError_t cudaMallocManaged(void * * devPtr, size_t size, unsigned int flags) {
    ...
    HOOK_CHECK(func_entry);
     cudaError_t result=func_entry(devPtr, size, flags);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT  cudaError_t cudaMalloc(void * * devPtr, size_t size) {
    ...
    HOOK_CHECK(func_entry);
     cudaError_t result=func_entry(devPtr, size);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT cudaError_t cudaMallocHost(void * * ptr, size_t size) {
    ...
    HOOK_CHECK(func_entry);
    cudaError_t result=func_entry(ptr, size);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT cudaError_t cudaMallocPitch(void * * devPtr, size_t * pitch, size_t width, size_t height) {
    ...
    HOOK_CHECK(func_entry);
    cudaError_t result=func_entry(devPtr, pitch, width, height);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT cudaError_t cudaMallocArray(cudaArray_t * array, const struct cudaChannelFormatDesc * desc, size_t width, size_t height, unsigned int flags) {
    ...
    HOOK_CHECK(func_entry);
    cudaError_t result=func_entry(array, desc, width, height, flags);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT cudaError_t cudaFreeHost(void * ptr) {
    ...
    HOOK_CHECK(func_entry);
    cudaError_t result=func_entry(ptr);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT cudaError_t cudaFreeArray(cudaArray_t array) {
    ...
    HOOK_CHECK(func_entry);
    cudaError_t result=func_entry(array);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT cudaError_t cudaFreeMipmappedArray(cudaMipmappedArray_t mipmappedArray) {
    ...
    HOOK_CHECK(func_entry);
    cudaError_t result=func_entry(mipmappedArray);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT cudaError_t cudaHostAlloc(void * * pHost, size_t size, unsigned int flags) {
    ...
    HOOK_CHECK(func_entry);
    cudaError_t result=func_entry(pHost, size, flags);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT cudaError_t cudaHostRegister(void * ptr, size_t size, unsigned int flags) {
    ...
    HOOK_CHECK(func_entry);
    cudaError_t result=func_entry(ptr, size, flags);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT cudaError_t cudaHostGetDevicePointer(void * * pDevice, void * pHost, unsigned int flags) {
    ...
    HOOK_CHECK(func_entry);
    cudaError_t result=func_entry(pDevice, pHost, flags);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT cudaError_t cudaHostGetFlags(unsigned int * pFlags, void * pHost) {
    ...
    HOOK_CHECK(func_entry);
    cudaError_t result=func_entry(pFlags, pHost);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT cudaError_t cudaMalloc3D(struct cudaPitchedPtr * pitchedDevPtr, struct cudaExtent extent) {
    ...
    HOOK_CHECK(func_entry);
    cudaError_t result=func_entry(pitchedDevPtr, extent);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT cudaError_t cudaMalloc3DArray(cudaArray_t * array, const struct cudaChannelFormatDesc * desc, struct cudaExtent extent, unsigned int flags) {
    ...
    HOOK_CHECK(func_entry);
    cudaError_t result=func_entry(array, desc, extent, flags);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT cudaError_t cudaMallocMipmappedArray(cudaMipmappedArray_t * mipmappedArray, const struct cudaChannelFormatDesc * desc, struct cudaExtent extent, unsigned int numLevels, unsigned int flags) {
    ...
    HOOK_CHECK(func_entry);
    cudaError_t result=func_entry(mipmappedArray, desc, extent, numLevels, flags);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT cudaError_t cudaGetMipmappedArrayLevel(cudaArray_t * levelArray, cudaMipmappedArray_const_t mipmappedArray, unsigned int level) {
    ...
    HOOK_CHECK(func_entry);
    cudaError_t result=func_entry(levelArray, mipmappedArray, level);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT cudaError_t cudaMemcpy3D(const struct cudaMemcpy3DParms * p) {
    ...
    HOOK_CHECK(func_entry);
    cudaError_t result=func_entry(p);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT  cudaError_t cudaMemcpy3DAsync(const struct cudaMemcpy3DParms * p, cudaStream_t stream) {
    ...
    HOOK_CHECK(func_entry);
     cudaError_t result=func_entry(p, stream);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT cudaError_t cudaMemGetInfo(size_t * free, size_t * total) {
    ...
    HOOK_CHECK(func_entry);
    cudaError_t result=func_entry(free, total);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT cudaError_t cudaArrayGetInfo(struct cudaChannelFormatDesc * desc, struct cudaExtent * extent, unsigned int * flags, cudaArray_t array) {
    ...
    HOOK_CHECK(func_entry);
    cudaError_t result=func_entry(desc, extent, flags, array);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT cudaError_t cudaArrayGetPlane(cudaArray_t * pPlaneArray, cudaArray_t hArray, unsigned int planeIdx) {
    ...
    HOOK_CHECK(func_entry);
    cudaError_t result=func_entry(pPlaneArray, hArray, planeIdx);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT cudaError_t cudaArrayGetMemoryRequirements(struct cudaArrayMemoryRequirements * memoryRequirements, cudaArray_t array, int device) {
    ...
    HOOK_CHECK(func_entry);
    cudaError_t result=func_entry(memoryRequirements, array, device);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT cudaError_t cudaMipmappedArrayGetMemoryRequirements(struct cudaArrayMemoryRequirements * memoryRequirements, cudaMipmappedArray_t mipmap, int device) {
    ...
    HOOK_CHECK(func_entry);
    cudaError_t result=func_entry(memoryRequirements, mipmap, device);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT cudaError_t cudaArrayGetSparseProperties(struct cudaArraySparseProperties * sparseProperties, cudaArray_t array) {
    ...
    HOOK_CHECK(func_entry);
    cudaError_t result=func_entry(sparseProperties, array);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT cudaError_t cudaMipmappedArrayGetSparseProperties(struct cudaArraySparseProperties * sparseProperties, cudaMipmappedArray_t mipmap) {
    ...
    HOOK_CHECK(func_entry);
    cudaError_t result=func_entry(sparseProperties, mipmap);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT cudaError_t cudaMemcpy(void * dst, const void * src, size_t count, enum cudaMemcpyKind kind) {
    ...
    HOOK_CHECK(func_entry);
    cudaError_t result=func_entry(dst, src, count, kind);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT cudaError_t cudaMemcpyPeer(void * dst, int dstDevice, const void * src, int srcDevice, size_t count) {
    ...
    HOOK_CHECK(func_entry);
    cudaError_t result=func_entry(dst, dstDevice, src, srcDevice, count);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT cudaError_t cudaMemcpy2D(void * dst, size_t dpitch, const void * src, size_t spitch, size_t width, size_t height, enum cudaMemcpyKind kind) {
    ...
    HOOK_CHECK(func_entry);
    cudaError_t result=func_entry(dst, dpitch, src, spitch, width, height, kind);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT cudaError_t cudaMemcpy2DToArray(cudaArray_t dst, size_t wOffset, size_t hOffset, const void * src, size_t spitch, size_t width, size_t height, enum cudaMemcpyKind kind) {
    ...
    HOOK_CHECK(func_entry);
    cudaError_t result=func_entry(dst, wOffset, hOffset, src, spitch, width, height, kind);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT cudaError_t cudaMemcpy2DFromArray(void * dst, size_t dpitch, cudaArray_const_t src, size_t wOffset, size_t hOffset, size_t width, size_t height, enum cudaMemcpyKind kind) {
    ...
    HOOK_CHECK(func_entry);
    cudaError_t result=func_entry(dst, dpitch, src, wOffset, hOffset, width, height, kind);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT cudaError_t cudaMemcpy2DArrayToArray(cudaArray_t dst, size_t wOffsetDst, size_t hOffsetDst, cudaArray_const_t src, size_t wOffsetSrc, size_t hOffsetSrc, size_t width, size_t height, enum cudaMemcpyKind kind) {
    ...
    using func_ptr = cudaError_t (*)(cudaArray_t, size_t, size_t, cudaArray_const_t, size_t, size_t, size_t, size_t, enum cudaMemcpyKind);
    static auto func_entry = reinterpret_cast<func_ptr>(HOOK_CUDART_SYMBOL("cudaMemcpy2DArrayToArray"));
    HOOK_CHECK(func_entry);
    cudaError_t result=func_entry(dst, wOffsetDst, hOffsetDst, src, wOffsetSrc, hOffsetSrc, width, height, kind);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT cudaError_t cudaMemcpyToSymbol(const void * symbol, const void * src, size_t count, size_t offset, enum cudaMemcpyKind kind) {
    ...
    HOOK_CHECK(func_entry);
    cudaError_t result=func_entry(symbol, src, count, offset, kind);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT cudaError_t cudaMemcpyFromSymbol(void * dst, const void * symbol, size_t count, size_t offset, enum cudaMemcpyKind kind) {
    ...
    HOOK_CHECK(func_entry);
    cudaError_t result=func_entry(dst, symbol, count, offset, kind);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT  cudaError_t cudaMemcpyAsync(void * dst, const void * src, size_t count, enum cudaMemcpyKind kind, cudaStream_t stream) {
    ...
    HOOK_CHECK(func_entry);
     cudaError_t result=func_entry(dst, src, count, kind, stream);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT cudaError_t cudaMemcpyPeerAsync(void * dst, int dstDevice, const void * src, int srcDevice, size_t count, cudaStream_t stream) {
    ...
    HOOK_CHECK(func_entry);
    cudaError_t result=func_entry(dst, dstDevice, src, srcDevice, count, stream);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT  cudaError_t cudaMemcpy2DAsync(void * dst, size_t dpitch, const void * src, size_t spitch, size_t width, size_t height, enum cudaMemcpyKind kind, cudaStream_t stream) {
    ...
    HOOK_CHECK(func_entry);
     cudaError_t result=func_entry(dst, dpitch, src, spitch, width, height, kind, stream);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT cudaError_t cudaMemcpy2DToArrayAsync(cudaArray_t dst, size_t wOffset, size_t hOffset, const void * src, size_t spitch, size_t width, size_t height, enum cudaMemcpyKind kind, cudaStream_t stream) {
    ...
    HOOK_CHECK(func_entry);
    cudaError_t result=func_entry(dst, wOffset, hOffset, src, spitch, width, height, kind, stream);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT cudaError_t cudaMemcpy2DFromArrayAsync(void * dst, size_t dpitch, cudaArray_const_t src, size_t wOffset, size_t hOffset, size_t width, size_t height, enum cudaMemcpyKind kind, cudaStream_t stream) {
    ...
    HOOK_CHECK(func_entry);
    cudaError_t result=func_entry(dst, dpitch, src, wOffset, hOffset, width, height, kind, stream);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT cudaError_t cudaMemcpyToSymbolAsync(const void * symbol, const void * src, size_t count, size_t offset, enum cudaMemcpyKind kind, cudaStream_t stream) {
    ...
    HOOK_CHECK(func_entry);
    cudaError_t result=func_entry(symbol, src, count, offset, kind, stream);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT cudaError_t cudaMemcpyFromSymbolAsync(void * dst, const void * symbol, size_t count, size_t offset, enum cudaMemcpyKind kind, cudaStream_t stream) {
    ...
    HOOK_CHECK(func_entry);
    cudaError_t result=func_entry(dst, symbol, count, offset, kind, stream);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT cudaError_t cudaMemset(void * devPtr, int value, size_t count) {
    ...
    HOOK_CHECK(func_entry);
    cudaError_t result=func_entry(devPtr, value, count);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT cudaError_t cudaMemset2D(void * devPtr, size_t pitch, int value, size_t width, size_t height) {
    ...
    HOOK_CHECK(func_entry);
    cudaError_t result=func_entry(devPtr, pitch, value, width, height);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT cudaError_t cudaMemset3D(struct cudaPitchedPtr pitchedDevPtr, int value, struct cudaExtent extent) {
    ...
    HOOK_CHECK(func_entry);
    cudaError_t result=func_entry(pitchedDevPtr, value, extent);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT  cudaError_t cudaMemsetAsync(void * devPtr, int value, size_t count, cudaStream_t stream) {
    ...
    HOOK_CHECK(func_entry);
     cudaError_t result=func_entry(devPtr, value, count, stream);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT  cudaError_t cudaMemset2DAsync(void * devPtr, size_t pitch, int value, size_t width, size_t height, cudaStream_t stream) {
    ...
    HOOK_CHECK(func_entry);
     cudaError_t result=func_entry(devPtr, pitch, value, width, height, stream);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT  cudaError_t cudaMemset3DAsync(struct cudaPitchedPtr pitchedDevPtr, int value, struct cudaExtent extent, cudaStream_t stream) {
    ...
    HOOK_CHECK(func_entry);
     cudaError_t result=func_entry(pitchedDevPtr, value, extent, stream);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT cudaError_t cudaGetSymbolAddress(void * * devPtr, const void * symbol) {
    ...
    HOOK_CHECK(func_entry);
    cudaError_t result=func_entry(devPtr, symbol);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT cudaError_t cudaGetSymbolSize(size_t * size, const void * symbol) {
    ...
    HOOK_CHECK(func_entry);
    cudaError_t result=func_entry(size, symbol);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT cudaError_t cudaMemPrefetchAsync(const void * devPtr, size_t count, int dstDevice, cudaStream_t stream) {
    ...
    HOOK_CHECK(func_entry);
    cudaError_t result=func_entry(devPtr, count, dstDevice, stream);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT cudaError_t cudaMemAdvise(const void * devPtr, size_t count, enum cudaMemoryAdvise advice, int device) {
    ...
    HOOK_CHECK(func_entry);
    cudaError_t result=func_entry(devPtr, count, advice, device);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT cudaError_t cudaMemRangeGetAttribute(void * data, size_t dataSize, enum cudaMemRangeAttribute attribute, const void * devPtr, size_t count) {
    ...
    HOOK_CHECK(func_entry);
    cudaError_t result=func_entry(data, dataSize, attribute, devPtr, count);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT cudaError_t cudaMemRangeGetAttributes(void * * data, size_t * dataSizes, enum cudaMemRangeAttribute * attributes, size_t numAttributes, const void * devPtr, size_t count) {
    ...
    HOOK_CHECK(func_entry);
    cudaError_t result=func_entry(data, dataSizes, attributes, numAttributes, devPtr, count);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT  cudaError_t cudaMemcpyToArray(cudaArray_t dst, size_t wOffset, size_t hOffset, const void * src, size_t count, enum cudaMemcpyKind kind) {
    ...
    HOOK_CHECK(func_entry);
     cudaError_t result=func_entry(dst, wOffset, hOffset, src, count, kind);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT  cudaError_t cudaMemcpyFromArray(void * dst, cudaArray_const_t src, size_t wOffset, size_t hOffset, size_t count, enum cudaMemcpyKind kind) {
    ...
    HOOK_CHECK(func_entry);
     cudaError_t result=func_entry(dst, src, wOffset, hOffset, count, kind);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT  cudaError_t cudaMemcpyArrayToArray(cudaArray_t dst, size_t wOffsetDst, size_t hOffsetDst, cudaArray_const_t src, size_t wOffsetSrc, size_t hOffsetSrc, size_t count, enum cudaMemcpyKind kind) {
    ...
    using func_ptr =  cudaError_t (*)(cudaArray_t, size_t, size_t, cudaArray_const_t, size_t, size_t, size_t, enum cudaMemcpyKind);
    static auto func_entry = reinterpret_cast<func_ptr>(HOOK_CUDART_SYMBOL("cudaMemcpyArrayToArray"));
    HOOK_CHECK(func_entry);
     cudaError_t result=func_entry(dst, wOffsetDst, hOffsetDst, src, wOffsetSrc, hOffsetSrc, count, kind);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT  cudaError_t cudaMemcpyToArrayAsync(cudaArray_t dst, size_t wOffset, size_t hOffset, const void * src, size_t count, enum cudaMemcpyKind kind, cudaStream_t stream) {
    ...
    HOOK_CHECK(func_entry);
     cudaError_t result=func_entry(dst, wOffset, hOffset, src, count, kind, stream);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT  cudaError_t cudaMemcpyFromArrayAsync(void * dst, cudaArray_const_t src, size_t wOffset, size_t hOffset, size_t count, enum cudaMemcpyKind kind, cudaStream_t stream) {
    ...
    HOOK_CHECK(func_entry);
     cudaError_t result=func_entry(dst, src, wOffset, hOffset, count, kind, stream);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT cudaError_t cudaMallocAsync(void * * devPtr, size_t size, cudaStream_t hStream) {
    ...
    HOOK_CHECK(func_entry);
    cudaError_t result=func_entry(devPtr, size, hStream);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT cudaError_t cudaFreeAsync(void * devPtr, cudaStream_t hStream) {
    ...
    HOOK_CHECK(func_entry);
    cudaError_t result=func_entry(devPtr, hStream);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT cudaError_t cudaMemPoolTrimTo(cudaMemPool_t memPool, size_t minBytesToKeep) {
    ...
    HOOK_CHECK(func_entry);
    cudaError_t result=func_entry(memPool, minBytesToKeep);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT cudaError_t cudaMemPoolSetAttribute(cudaMemPool_t memPool, enum cudaMemPoolAttr attr, void * value) {
    ...
    HOOK_CHECK(func_entry);
    cudaError_t result=func_entry(memPool, attr, value);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT cudaError_t cudaMemPoolSetAccess(cudaMemPool_t memPool, const struct cudaMemAccessDesc * descList, size_t count) {
    ...
    HOOK_CHECK(func_entry);
    cudaError_t result=func_entry(memPool, descList, count);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT cudaError_t cudaMemPoolGetAccess(enum cudaMemAccessFlags * flags, cudaMemPool_t memPool, struct cudaMemLocation * location) {
    ...
    HOOK_CHECK(func_entry);
    cudaError_t result=func_entry(flags, memPool, location);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT cudaError_t cudaMemPoolCreate(cudaMemPool_t * memPool, const struct cudaMemPoolProps * poolProps) {
    ...
    HOOK_CHECK(func_entry);
    cudaError_t result=func_entry(memPool, poolProps);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT cudaError_t cudaMemPoolDestroy(cudaMemPool_t memPool) {
    ...
    HOOK_CHECK(func_entry);
    cudaError_t result=func_entry(memPool);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT cudaError_t cudaMallocFromPoolAsync(void * * ptr, size_t size, cudaMemPool_t memPool, cudaStream_t stream) {
    ...
    HOOK_CHECK(func_entry);
    cudaError_t result=func_entry(ptr, size, memPool, stream);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT cudaError_t cudaMemPoolExportToShareableHandle(void * shareableHandle, cudaMemPool_t memPool, enum cudaMemAllocationHandleType handleType, unsigned int flags) {
    ...
    HOOK_CHECK(func_entry);
    cudaError_t result=func_entry(shareableHandle, memPool, handleType, flags);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT cudaError_t cudaMemPoolImportFromShareableHandle(cudaMemPool_t * memPool, void * shareableHandle, enum cudaMemAllocationHandleType handleType, unsigned int flags) {
    ...
    HOOK_CHECK(func_entry);
    cudaError_t result=func_entry(memPool, shareableHandle, handleType, flags);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT cudaError_t cudaMemPoolExportPointer(struct cudaMemPoolPtrExportData * exportData, void * ptr) {
    ...
    HOOK_CHECK(func_entry);
    cudaError_t result=func_entry(exportData, ptr);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT cudaError_t cudaMemPoolImportPointer(void * * ptr, cudaMemPool_t memPool, struct cudaMemPoolPtrExportData * exportData) {
    ...
    HOOK_CHECK(func_entry);
    cudaError_t result=func_entry(ptr, memPool, exportData);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT cudaError_t cudaPointerGetAttributes(struct cudaPointerAttributes * attributes, const void * ptr) {
    ...
    HOOK_CHECK(func_entry);
    cudaError_t result=func_entry(attributes, ptr);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT cudaError_t cudaDeviceCanAccessPeer(int * canAccessPeer, int device, int peerDevice) {
    ...
    HOOK_CHECK(func_entry);
    cudaError_t result=func_entry(canAccessPeer, device, peerDevice);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT cudaError_t cudaDeviceEnablePeerAccess(int peerDevice, unsigned int flags) {
    ...
    HOOK_CHECK(func_entry);
    cudaError_t result=func_entry(peerDevice, flags);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT cudaError_t cudaDeviceDisablePeerAccess(int peerDevice) {
    ...
    HOOK_CHECK(func_entry);
    cudaError_t result=func_entry(peerDevice);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT cudaError_t cudaGraphicsUnregisterResource(cudaGraphicsResource_t resource) {
    ...
    HOOK_CHECK(func_entry);
    cudaError_t result=func_entry(resource);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT cudaError_t cudaGraphicsResourceSetMapFlags(cudaGraphicsResource_t resource, unsigned int flags) {
    ...
    HOOK_CHECK(func_entry);
    cudaError_t result=func_entry(resource, flags);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT cudaError_t cudaGraphicsMapResources(int count, cudaGraphicsResource_t * resources, cudaStream_t stream) {
    ...
    HOOK_CHECK(func_entry);
    cudaError_t result=func_entry(count, resources, stream);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT cudaError_t cudaGraphicsResourceGetMappedPointer(void * * devPtr, size_t * size, cudaGraphicsResource_t resource) {
    ...
    HOOK_CHECK(func_entry);
    cudaError_t result=func_entry(devPtr, size, resource);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT cudaError_t cudaGraphicsSubResourceGetMappedArray(cudaArray_t * array, cudaGraphicsResource_t resource, unsigned int arrayIndex, unsigned int mipLevel) {
    ...
    HOOK_CHECK(func_entry);
    cudaError_t result=func_entry(array, resource, arrayIndex, mipLevel);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT cudaError_t cudaGraphicsResourceGetMappedMipmappedArray(cudaMipmappedArray_t * mipmappedArray, cudaGraphicsResource_t resource) {
    ...
    HOOK_CHECK(func_entry);
    cudaError_t result=func_entry(mipmappedArray, resource);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT cudaError_t cudaGetChannelDesc(struct cudaChannelFormatDesc * desc, cudaArray_const_t array) {
    ...
    HOOK_CHECK(func_entry);
    cudaError_t result=func_entry(desc, array);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT struct cudaChannelFormatDesc cudaCreateChannelDesc(int x, int y, int z, int w, enum cudaChannelFormatKind f) {
    ...
    HOOK_CHECK(func_entry);
    struct cudaChannelFormatDesc result=func_entry(x, y, z, w, f);
    // RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT cudaError_t cudaCreateTextureObject(cudaTextureObject_t * pTexObject, const struct cudaResourceDesc * pResDesc, const struct cudaTextureDesc * pTexDesc, const struct cudaResourceViewDesc * pResViewDesc) {
    ...
    HOOK_CHECK(func_entry);
    cudaError_t result=func_entry(pTexObject, pResDesc, pTexDesc, pResViewDesc);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT cudaError_t cudaDestroyTextureObject(cudaTextureObject_t texObject) {
    ...
    HOOK_CHECK(func_entry);
    cudaError_t result=func_entry(texObject);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT cudaError_t cudaGetTextureObjectResourceDesc(struct cudaResourceDesc * pResDesc, cudaTextureObject_t texObject) {
    ...
    HOOK_CHECK(func_entry);
    cudaError_t result=func_entry(pResDesc, texObject);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT cudaError_t cudaGetTextureObjectTextureDesc(struct cudaTextureDesc * pTexDesc, cudaTextureObject_t texObject) {
    ...
    HOOK_CHECK(func_entry);
    cudaError_t result=func_entry(pTexDesc, texObject);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT cudaError_t cudaGetTextureObjectResourceViewDesc(struct cudaResourceViewDesc * pResViewDesc, cudaTextureObject_t texObject) {
    ...
    HOOK_CHECK(func_entry);
    cudaError_t result=func_entry(pResViewDesc, texObject);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT cudaError_t cudaCreateSurfaceObject(cudaSurfaceObject_t * pSurfObject, const struct cudaResourceDesc * pResDesc) {
    ...
    HOOK_CHECK(func_entry);
    cudaError_t result=func_entry(pSurfObject, pResDesc);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT cudaError_t cudaDestroySurfaceObject(cudaSurfaceObject_t surfObject) {
    ...
    HOOK_CHECK(func_entry);
    cudaError_t result=func_entry(surfObject);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT cudaError_t cudaGetSurfaceObjectResourceDesc(struct cudaResourceDesc * pResDesc, cudaSurfaceObject_t surfObject) {
    ...
    HOOK_CHECK(func_entry);
    cudaError_t result=func_entry(pResDesc, surfObject);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT cudaError_t cudaDriverGetVersion(int * driverVersion) {
    ...
    HOOK_CHECK(func_entry);
    cudaError_t result=func_entry(driverVersion);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT  cudaError_t cudaRuntimeGetVersion(int * runtimeVersion) {
    ...
    HOOK_CHECK(func_entry);
     cudaError_t result=func_entry(runtimeVersion);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT cudaError_t cudaGraphCreate(cudaGraph_t * pGraph, unsigned int flags) {
    ...
    HOOK_CHECK(func_entry);
    cudaError_t result=func_entry(pGraph, flags);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT cudaError_t cudaGraphAddKernelNode(cudaGraphNode_t * pGraphNode, cudaGraph_t graph, const cudaGraphNode_t * pDependencies, size_t numDependencies, const struct cudaKernelNodeParams * pNodeParams) {
    ...
    HOOK_CHECK(func_entry);
    cudaError_t result=func_entry(pGraphNode, graph, pDependencies, numDependencies, pNodeParams);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT cudaError_t cudaGraphKernelNodeGetParams(cudaGraphNode_t node, struct cudaKernelNodeParams * pNodeParams) {
    ...
    HOOK_CHECK(func_entry);
    cudaError_t result=func_entry(node, pNodeParams);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT cudaError_t cudaGraphKernelNodeCopyAttributes(cudaGraphNode_t hSrc, cudaGraphNode_t hDst) {
    ...
    HOOK_CHECK(func_entry);
    cudaError_t result=func_entry(hSrc, hDst);
    RESULT_CHECK(result);
    return result;
}

HOOK_C_API HOOK_DECL_EXPORT cudaError_t cudaGraphKernelNodeGetAttribute(cudaGraphNode_t hNode, cudaKernelNodeAttrID attr, cudaKernelNodeAttrValue * value_out) {
    HOOK_TRACE_PROFILE("cudaGraphKernelNodeGetAttribute");
    using func_ptr = cudaError_t (*)(cudaGraphNode_t, cudaKernelNodeAttrID, cudaKernelNodeAttrValue *);
    static auto func_entry = reinterpret_cast<func_ptr>(HOOK_CUDART_SYMBOL("cudaGraphKernelNodeGetAttribute"));
    HOOK_CHECK(func_entry);
    cudaError_t result=func_entry(hNode, attr, value_out);
    RESULT_CHECK(result);
    return result;
}

HOOK_C_API HOOK_DECL_EXPORT cudaError_t cudaGraphKernelNodeSetAttribute(cudaGraphNode_t hNode, cudaKernelNodeAttrID attr, const cudaKernelNodeAttrValue * value) {
    HOOK_TRACE_PROFILE("cudaGraphKernelNodeSetAttribute");
    using func_ptr = cudaError_t (*)(cudaGraphNode_t, cudaKernelNodeAttrID, const cudaKernelNodeAttrValue *);
    static auto func_entry = reinterpret_cast<func_ptr>(HOOK_CUDART_SYMBOL("cudaGraphKernelNodeSetAttribute"));
    HOOK_CHECK(func_entry);
    cudaError_t result=func_entry(hNode, attr, value);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT cudaError_t cudaGraphAddMemcpyNode(cudaGraphNode_t * pGraphNode, cudaGraph_t graph, const cudaGraphNode_t * pDependencies, size_t numDependencies, const struct cudaMemcpy3DParms * pCopyParams) {
    ...
    HOOK_CHECK(func_entry);
    cudaError_t result=func_entry(pGraphNode, graph, pDependencies, numDependencies, pCopyParams);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT cudaError_t cudaGraphAddMemcpyNodeToSymbol(cudaGraphNode_t * pGraphNode, cudaGraph_t graph, const cudaGraphNode_t * pDependencies, size_t numDependencies, const void * symbol, const void * src, size_t count, size_t offset, enum cudaMemcpyKind kind) {
    ...
    HOOK_CHECK(func_entry);
    cudaError_t result=func_entry(pGraphNode, graph, pDependencies, numDependencies, symbol, src, count, offset, kind);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT cudaError_t cudaGraphAddMemcpyNodeFromSymbol(cudaGraphNode_t * pGraphNode, cudaGraph_t graph, const cudaGraphNode_t * pDependencies, size_t numDependencies, void * dst, const void * symbol, size_t count, size_t offset, enum cudaMemcpyKind kind) {
    ...
    HOOK_CHECK(func_entry);
    cudaError_t result=func_entry(pGraphNode, graph, pDependencies, numDependencies, dst, symbol, count, offset, kind);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT cudaError_t cudaGraphAddMemcpyNode1D(cudaGraphNode_t * pGraphNode, cudaGraph_t graph, const cudaGraphNode_t * pDependencies, size_t numDependencies, void * dst, const void * src, size_t count, enum cudaMemcpyKind kind) {
    ...
    HOOK_CHECK(func_entry);
    cudaError_t result=func_entry(pGraphNode, graph, pDependencies, numDependencies, dst, src, count, kind);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT cudaError_t cudaGraphMemcpyNodeSetParamsToSymbol(cudaGraphNode_t node, const void * symbol, const void * src, size_t count, size_t offset, enum cudaMemcpyKind kind) {
    ...
    HOOK_CHECK(func_entry);
    cudaError_t result=func_entry(node, symbol, src, count, offset, kind);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT cudaError_t cudaGraphMemcpyNodeSetParamsFromSymbol(cudaGraphNode_t node, void * dst, const void * symbol, size_t count, size_t offset, enum cudaMemcpyKind kind) {
    ...
    HOOK_CHECK(func_entry);
    cudaError_t result=func_entry(node, dst, symbol, count, offset, kind);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT cudaError_t cudaGraphMemcpyNodeSetParams1D(cudaGraphNode_t node, void * dst, const void * src, size_t count, enum cudaMemcpyKind kind) {
    ...
    HOOK_CHECK(func_entry);
    cudaError_t result=func_entry(node, dst, src, count, kind);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT cudaError_t cudaGraphAddMemsetNode(cudaGraphNode_t * pGraphNode, cudaGraph_t graph, const cudaGraphNode_t * pDependencies, size_t numDependencies, const struct cudaMemsetParams * pMemsetParams) {
    ...
    HOOK_CHECK(func_entry);
    cudaError_t result=func_entry(pGraphNode, graph, pDependencies, numDependencies, pMemsetParams);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT cudaError_t cudaGraphAddChildGraphNode(cudaGraphNode_t * pGraphNode, cudaGraph_t graph, const cudaGraphNode_t * pDependencies, size_t numDependencies, cudaGraph_t childGraph) {
    ...
    HOOK_CHECK(func_entry);
    cudaError_t result=func_entry(pGraphNode, graph, pDependencies, numDependencies, childGraph);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT cudaError_t cudaGraphChildGraphNodeGetGraph(cudaGraphNode_t node, cudaGraph_t * pGraph) {
    ...
    HOOK_CHECK(func_entry);
    cudaError_t result=func_entry(node, pGraph);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT cudaError_t cudaGraphAddEmptyNode(cudaGraphNode_t * pGraphNode, cudaGraph_t graph, const cudaGraphNode_t * pDependencies, size_t numDependencies) {
    ...
    HOOK_CHECK(func_entry);
    cudaError_t result=func_entry(pGraphNode, graph, pDependencies, numDependencies);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT cudaError_t cudaGraphAddEventRecordNode(cudaGraphNode_t * pGraphNode, cudaGraph_t graph, const cudaGraphNode_t * pDependencies, size_t numDependencies, cudaEvent_t event) {
    ...
    HOOK_CHECK(func_entry);
    cudaError_t result=func_entry(pGraphNode, graph, pDependencies, numDependencies, event);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT cudaError_t cudaGraphEventRecordNodeGetEvent(cudaGraphNode_t node, cudaEvent_t * event_out) {
    ...
    HOOK_CHECK(func_entry);
    cudaError_t result=func_entry(node, event_out);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT cudaError_t cudaGraphEventRecordNodeSetEvent(cudaGraphNode_t node, cudaEvent_t event) {
    ...
    HOOK_CHECK(func_entry);
    cudaError_t result=func_entry(node, event);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT cudaError_t cudaGraphAddExternalSemaphoresSignalNode(cudaGraphNode_t * pGraphNode, cudaGraph_t graph, const cudaGraphNode_t * pDependencies, size_t numDependencies, const struct cudaExternalSemaphoreSignalNodeParams * nodeParams) {
    ...
    HOOK_CHECK(func_entry);
    cudaError_t result=func_entry(pGraphNode, graph, pDependencies, numDependencies, nodeParams);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT cudaError_t cudaGraphExternalSemaphoresSignalNodeGetParams(cudaGraphNode_t hNode, struct cudaExternalSemaphoreSignalNodeParams * params_out) {
    ...
    HOOK_CHECK(func_entry);
    cudaError_t result=func_entry(hNode, params_out);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT cudaError_t cudaGraphExternalSemaphoresSignalNodeSetParams(cudaGraphNode_t hNode, const struct cudaExternalSemaphoreSignalNodeParams * nodeParams) {
    ...
    HOOK_CHECK(func_entry);
    cudaError_t result=func_entry(hNode, nodeParams);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT cudaError_t cudaGraphMemAllocNodeGetParams(cudaGraphNode_t node, struct cudaMemAllocNodeParams * params_out) {
    ...
    HOOK_CHECK(func_entry);
    cudaError_t result=func_entry(node, params_out);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT cudaError_t cudaGraphAddMemFreeNode(cudaGraphNode_t * pGraphNode, cudaGraph_t graph, const cudaGraphNode_t * pDependencies, size_t numDependencies, void * dptr) {
    ...
    HOOK_CHECK(func_entry);
    cudaError_t result=func_entry(pGraphNode, graph, pDependencies, numDependencies, dptr);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT cudaError_t cudaGraphMemFreeNodeGetParams(cudaGraphNode_t node, void * dptr_out) {
    ...
    HOOK_CHECK(func_entry);
    cudaError_t result=func_entry(node, dptr_out);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT cudaError_t cudaDeviceGetGraphMemAttribute(int device, enum cudaGraphMemAttributeType attr, void * value) {
    ...
    HOOK_CHECK(func_entry);
    cudaError_t result=func_entry(device, attr, value);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT cudaError_t cudaGraphClone(cudaGraph_t * pGraphClone, cudaGraph_t originalGraph) {
    ...
    HOOK_CHECK(func_entry);
    cudaError_t result=func_entry(pGraphClone, originalGraph);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT cudaError_t cudaGraphNodeFindInClone(cudaGraphNode_t * pNode, cudaGraphNode_t originalNode, cudaGraph_t clonedGraph) {
    ...
    HOOK_CHECK(func_entry);
    cudaError_t result=func_entry(pNode, originalNode, clonedGraph);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT cudaError_t cudaGraphNodeGetType(cudaGraphNode_t node, enum cudaGraphNodeType * pType) {
    ...
    HOOK_CHECK(func_entry);
    cudaError_t result=func_entry(node, pType);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT cudaError_t cudaGraphGetNodes(cudaGraph_t graph, cudaGraphNode_t * nodes, size_t * numNodes) {
    ...
    HOOK_CHECK(func_entry);
    cudaError_t result=func_entry(graph, nodes, numNodes);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT cudaError_t cudaGraphGetRootNodes(cudaGraph_t graph, cudaGraphNode_t * pRootNodes, size_t * pNumRootNodes) {
    ...
    HOOK_CHECK(func_entry);
    cudaError_t result=func_entry(graph, pRootNodes, pNumRootNodes);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT cudaError_t cudaGraphGetEdges(cudaGraph_t graph, cudaGraphNode_t * from, cudaGraphNode_t * to, size_t * numEdges) {
    ...
    HOOK_CHECK(func_entry);
    cudaError_t result=func_entry(graph, from, to, numEdges);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT cudaError_t cudaGraphNodeGetDependencies(cudaGraphNode_t node, cudaGraphNode_t * pDependencies, size_t * pNumDependencies) {
    ...
    HOOK_CHECK(func_entry);
    cudaError_t result=func_entry(node, pDependencies, pNumDependencies);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT cudaError_t cudaGraphNodeGetDependentNodes(cudaGraphNode_t node, cudaGraphNode_t * pDependentNodes, size_t * pNumDependentNodes) {
    ...
    HOOK_CHECK(func_entry);
    cudaError_t result=func_entry(node, pDependentNodes, pNumDependentNodes);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT cudaError_t cudaGraphAddDependencies(cudaGraph_t graph, const cudaGraphNode_t * from, const cudaGraphNode_t * to, size_t numDependencies) {
    ...
    HOOK_CHECK(func_entry);
    cudaError_t result=func_entry(graph, from, to, numDependencies);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT cudaError_t cudaGraphDestroyNode(cudaGraphNode_t node) {
    ...
    HOOK_CHECK(func_entry);
    cudaError_t result=func_entry(node);
    RESULT_CHECK(result);
    return result;
}

HOOK_C_API HOOK_DECL_EXPORT cudaError_t cudaGraphInstantiate(cudaGraphExec_t * pGraphExec, cudaGraph_t graph, unsigned long long flags) {
    ...
    HOOK_CHECK(func_entry);
    cudaError_t result=func_entry(pGraphExec, graph, flags);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT cudaError_t cudaGraphInstantiateWithParams(cudaGraphExec_t * pGraphExec, cudaGraph_t graph, cudaGraphInstantiateParams * instantiateParams) {
    HOOK_TRACE_PROFILE("cudaGraphInstantiateWithParams");
    using func_ptr = cudaError_t (*)(cudaGraphExec_t *, cudaGraph_t, cudaGraphInstantiateParams *);
    static auto func_entry = reinterpret_cast<func_ptr>(HOOK_CUDART_SYMBOL("cudaGraphInstantiateWithParams"));
    HOOK_CHECK(func_entry);
    cudaError_t result=func_entry(pGraphExec, graph, instantiateParams);
    RESULT_CHECK(result);
    return result;
}

HOOK_C_API HOOK_DECL_EXPORT cudaError_t cudaGraphExecGetFlags(cudaGraphExec_t graphExec, unsigned long long * flags) {
    HOOK_TRACE_PROFILE("cudaGraphExecGetFlags");
    using func_ptr = cudaError_t (*)(cudaGraphExec_t, unsigned long long *);
    static auto func_entry = reinterpret_cast<func_ptr>(HOOK_CUDART_SYMBOL("cudaGraphExecGetFlags"));
    HOOK_CHECK(func_entry);
    cudaError_t result=func_entry(graphExec, flags);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT cudaError_t cudaGraphExecKernelNodeSetParams(cudaGraphExec_t hGraphExec, cudaGraphNode_t node, const struct cudaKernelNodeParams * pNodeParams) {
    ...
    HOOK_CHECK(func_entry);
    cudaError_t result=func_entry(hGraphExec, node, pNodeParams);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT cudaError_t cudaGraphExecMemcpyNodeSetParamsToSymbol(cudaGraphExec_t hGraphExec, cudaGraphNode_t node, const void * symbol, const void * src, size_t count, size_t offset, enum cudaMemcpyKind kind) {
    ...
    HOOK_CHECK(func_entry);
    cudaError_t result=func_entry(hGraphExec, node, symbol, src, count, offset, kind);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT cudaError_t cudaGraphExecMemcpyNodeSetParamsFromSymbol(cudaGraphExec_t hGraphExec, cudaGraphNode_t node, void * dst, const void * symbol, size_t count, size_t offset, enum cudaMemcpyKind kind) {
    ...
    HOOK_CHECK(func_entry);
    cudaError_t result=func_entry(hGraphExec, node, dst, symbol, count, offset, kind);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT cudaError_t cudaGraphExecMemcpyNodeSetParams1D(cudaGraphExec_t hGraphExec, cudaGraphNode_t node, void * dst, const void * src, size_t count, enum cudaMemcpyKind kind) {
    ...
    HOOK_CHECK(func_entry);
    cudaError_t result=func_entry(hGraphExec, node, dst, src, count, kind);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT cudaError_t cudaGraphExecChildGraphNodeSetParams(cudaGraphExec_t hGraphExec, cudaGraphNode_t node, cudaGraph_t childGraph) {
    ...
    HOOK_CHECK(func_entry);
    cudaError_t result=func_entry(hGraphExec, node, childGraph);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT cudaError_t cudaGraphExecEventRecordNodeSetEvent(cudaGraphExec_t hGraphExec, cudaGraphNode_t hNode, cudaEvent_t event) {
    ...
    HOOK_CHECK(func_entry);
    cudaError_t result=func_entry(hGraphExec, hNode, event);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT cudaError_t cudaGraphExecExternalSemaphoresSignalNodeSetParams(cudaGraphExec_t hGraphExec, cudaGraphNode_t hNode, const struct cudaExternalSemaphoreSignalNodeParams * nodeParams) {
    ...
    HOOK_CHECK(func_entry);
    cudaError_t result=func_entry(hGraphExec, hNode, nodeParams);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT cudaError_t cudaGraphNodeSetEnabled(cudaGraphExec_t hGraphExec, cudaGraphNode_t hNode, unsigned int isEnabled) {
    ...
    HOOK_CHECK(func_entry);
    cudaError_t result=func_entry(hGraphExec, hNode, isEnabled);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT cudaError_t cudaGraphExecUpdate(cudaGraphExec_t hGraphExec, cudaGraph_t hGraph, cudaGraphExecUpdateResultInfo * resultInfo) {
    HOOK_TRACE_PROFILE("cudaGraphExecUpdate");
    using func_ptr = cudaError_t (*)(cudaGraphExec_t, cudaGraph_t, cudaGraphExecUpdateResultInfo *);
    static auto func_entry = reinterpret_cast<func_ptr>(HOOK_CUDART_SYMBOL("cudaGraphExecUpdate"));
    HOOK_CHECK(func_entry);
    cudaError_t result=func_entry(hGraphExec, hGraph, resultInfo);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT cudaError_t cudaGraphUpload(cudaGraphExec_t graphExec, cudaStream_t stream) {
    ...
    HOOK_CHECK(func_entry);
    cudaError_t result=func_entry(graphExec, stream);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT cudaError_t cudaGraphExecDestroy(cudaGraphExec_t graphExec) {
    ...
    HOOK_CHECK(func_entry);
    cudaError_t result=func_entry(graphExec);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT cudaError_t cudaGraphDestroy(cudaGraph_t graph) {
    ...
    HOOK_CHECK(func_entry);
    cudaError_t result=func_entry(graph);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT cudaError_t cudaGraphDebugDotPrint(cudaGraph_t graph, const char * path, unsigned int flags) {
    ...
    HOOK_CHECK(func_entry);
    cudaError_t result=func_entry(graph, path, flags);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT cudaError_t cudaUserObjectCreate(cudaUserObject_t * object_out, void * ptr, cudaHostFn_t destroy, unsigned int initialRefcount, unsigned int flags) {
    ...
    HOOK_CHECK(func_entry);
    cudaError_t result=func_entry(object_out, ptr, destroy, initialRefcount, flags);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT cudaError_t cudaUserObjectRetain(cudaUserObject_t object, unsigned int count) {
    ...
    HOOK_CHECK(func_entry);
    cudaError_t result=func_entry(object, count);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT cudaError_t cudaGraphRetainUserObject(cudaGraph_t graph, cudaUserObject_t object, unsigned int count, unsigned int flags) {
    ...
    HOOK_CHECK(func_entry);
    cudaError_t result=func_entry(graph, object, count, flags);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT cudaError_t cudaGraphReleaseUserObject(cudaGraph_t graph, cudaUserObject_t object, unsigned int count) {
    ...
    HOOK_CHECK(func_entry);
    cudaError_t result=func_entry(graph, object, count);
    RESULT_CHECK(result);
    return result;
}

HOOK_C_API HOOK_DECL_EXPORT cudaError_t cudaGraphAddNode(cudaGraphNode_t * pGraphNode, cudaGraph_t graph, const cudaGraphNode_t * pDependencies, size_t numDependencies, struct cudaGraphNodeParams * nodeParams) {
    HOOK_TRACE_PROFILE("cudaGraphAddNode");
    using func_ptr = cudaError_t (*)(cudaGraphNode_t *, cudaGraph_t, const cudaGraphNode_t *, size_t, struct cudaGraphNodeParams *);
    static auto func_entry = reinterpret_cast<func_ptr>(HOOK_CUDART_SYMBOL("cudaGraphAddNode"));
    HOOK_CHECK(func_entry);
    cudaError_t result=func_entry(pGraphNode, graph, pDependencies, numDependencies, nodeParams);
    RESULT_CHECK(result);
    return result;
...
HOOK_C_API HOOK_DECL_EXPORT cudaError_t cudaGraphNodeSetParams(cudaGraphNode_t node, struct cudaGraphNodeParams * nodeParams) {
    HOOK_TRACE_PROFILE("cudaGraphNodeSetParams");
    using func_ptr = cudaError_t (*)(cudaGraphNode_t, struct cudaGraphNodeParams *);
    static auto func_entry = reinterpret_cast<func_ptr>(HOOK_CUDART_SYMBOL("cudaGraphNodeSetParams"));
    HOOK_CHECK(func_entry);
    cudaError_t result=func_entry(node, nodeParams);
    RESULT_CHECK(result);
    return result;
}

HOOK_C_API HOOK_DECL_EXPORT cudaError_t cudaGraphExecNodeSetParams(cudaGraphExec_t graphExec, cudaGraphNode_t node, struct cudaGraphNodeParams * nodeParams) {
    HOOK_TRACE_PROFILE("cudaGraphExecNodeSetParams");
    using func_ptr = cudaError_t (*)(cudaGraphExec_t, cudaGraphNode_t, struct cudaGraphNodeParams *);
    static auto func_entry = reinterpret_cast<func_ptr>(HOOK_CUDART_SYMBOL("cudaGraphExecNodeSetParams"));
    HOOK_CHECK(func_entry);
    cudaError_t result=func_entry(graphExec, node, nodeParams);
    RESULT_CHECK(result);
    return result;
}

HOOK_C_API HOOK_DECL_EXPORT cudaError_t cudaGraphConditionalHandleCreate(cudaGraphConditionalHandle * pHandle_out, cudaGraph_t graph, unsigned int defaultLaunchValue, unsigned int flags) {
    HOOK_TRACE_PROFILE("cudaGraphConditionalHandleCreate");
    using func_ptr = cudaError_t (*)(cudaGraphConditionalHandle *, cudaGraph_t, unsigned int, unsigned int);
    static auto func_entry = reinterpret_cast<func_ptr>(HOOK_CUDART_SYMBOL("cudaGraphConditionalHandleCreate"));
    HOOK_CHECK(func_entry);
    cudaError_t result=func_entry(pHandle_out, graph, defaultLaunchValue, flags);
    RESULT_CHECK(result);
    return result;
}

HOOK_C_API HOOK_DECL_EXPORT cudaError_t cudaGetDriverEntryPoint(const char * symbol, void * * funcPtr, unsigned long long flags, enum cudaDriverEntryPointQueryResult * driverStatus) {
    HOOK_TRACE_PROFILE("cudaGetDriverEntryPoint");
    using func_ptr = cudaError_t (*)(const char *, void * *, unsigned long long, enum cudaDriverEntryPointQueryResult *);
    static auto func_entry = reinterpret_cast<func_ptr>(HOOK_CUDART_SYMBOL("cudaGetDriverEntryPoint"));
    HOOK_CHECK(func_entry);
    cudaError_t result=func_entry(symbol, funcPtr, flags, driverStatus);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT cudaError_t cudaGetExportTable(const void * * ppExportTable, const cudaUUID_t * pExportTableId) {
    ...
    HOOK_CHECK(func_entry);
    cudaError_t result=func_entry(ppExportTable, pExportTableId);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT cudaError_t cudaGetFuncBySymbol(cudaFunction_t * functionPtr, const void * symbolPtr) {
    ...
    HOOK_CHECK(func_entry);
    cudaError_t result=func_entry(functionPtr, symbolPtr);
    RESULT_CHECK(result);
    return result;
}

HOOK_C_API HOOK_DECL_EXPORT cudaError_t cudaGetKernel(cudaKernel_t * kernelPtr, const void * entryFuncAddr) {
    HOOK_TRACE_PROFILE("cudaGetKernel");
    using func_ptr = cudaError_t (*)(cudaKernel_t *, const void *);
    static auto func_entry = reinterpret_cast<func_ptr>(HOOK_CUDART_SYMBOL("cudaGetKernel"));
    HOOK_CHECK(func_entry);
    cudaError_t result=func_entry(kernelPtr, entryFuncAddr);
    RESULT_CHECK(result);
    return result;
}
...
HOOK_C_API HOOK_DECL_EXPORT cudaError_t cudaStreamGetCaptureInfo_ptsz(cudaStream_t stream, enum cudaStreamCaptureStatus * captureStatus_out, unsigned long long * id_out) {
    HOOK_TRACE_PROFILE("cudaStreamGetCaptureInfo_ptsz");
    using func_ptr = cudaError_t (*)(cudaStream_t, enum cudaStreamCaptureStatus *, unsigned long long *);
    static auto func_entry = reinterpret_cast<func_ptr>(HOOK_CUDART_SYMBOL("cudaStreamGetCaptureInfo_ptsz"));
    HOOK_CHECK(func_entry);
    cudaError_t result=func_entry(stream, captureStatus_out, id_out);
    RESULT_CHECK(result);
    return result;
}
