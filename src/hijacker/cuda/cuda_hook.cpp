...
DEF_FN(CUresult,cuGetErrorString_v6000,CUresult,error, const char**,pStr);
DEF_FN(CUresult,cuGetErrorName_v6000,CUresult,error, const char**,pStr);
DEF_FN(CUresult,cuInit_v2000,unsigned int,Flags);
DEF_FN(CUresult,cuDriverGetVersion_v2020,int*,driverVersion);
DEF_FN(CUresult,cuDeviceGet_v2000,CUdevice_v1*,device, int,ordinal);
DEF_FN(CUresult,cuDeviceGetCount_v2000,int*,count);
DEF_FN(CUresult,cuDeviceGetName_v2000,char*,name, int,len, CUdevice_v1,dev);
DEF_FN(CUresult,cuDeviceGetUuid_v9020,CUuuid*,uuid, CUdevice_v1,dev);
DEF_FN(CUresult,cuDeviceGetUuid_v11040,CUuuid*,uuid, CUdevice_v1,dev);
DEF_FN(CUresult,cuDeviceGetLuid_v10000,char*,luid, unsigned int*,deviceNodeMask, CUdevice_v1,dev);
DEF_FN(CUresult,cuDeviceTotalMem_v3020,size_t*,bytes, CUdevice_v1,dev);
DEF_FN(CUresult,cuDeviceGetTexture1DLinearMaxWidth_v11010,size_t*,maxWidthInElements, CUarray_format,format, unsigned,numChannels, CUdevice_v1,dev);
DEF_FN(CUresult,cuDeviceGetAttribute_v2000,int*,pi, CUdevice_attribute,attrib, CUdevice_v1,dev);
DEF_FN(CUresult,cuDeviceGetNvSciSyncAttributes_v10020,void*,nvSciSyncAttrList, CUdevice_v1,dev, int,flags);
DEF_FN(CUresult,cuDeviceSetMemPool_v11020,CUdevice_v1,dev, CUmemoryPool,pool);
DEF_FN(CUresult,cuDeviceGetMemPool_v11020,CUmemoryPool*,pool, CUdevice_v1,dev);
DEF_FN(CUresult,cuDeviceGetDefaultMemPool_v11020,CUmemoryPool*,pool_out, CUdevice_v1,dev);
DEF_FN(CUresult,cuDeviceGetProperties_v2000,CUdevprop_v1*,prop, CUdevice_v1,dev);
DEF_FN(CUresult,cuDeviceComputeCapability_v2000,int*,major, int*,minor, CUdevice_v1,dev);
DEF_FN(CUresult,cuDevicePrimaryCtxRetain_v7000,CUcontext*,pctx, CUdevice_v1,dev);
DEF_FN(CUresult,cuDevicePrimaryCtxRelease_v11000,CUdevice_v1,dev);
DEF_FN(CUresult,cuDevicePrimaryCtxSetFlags_v11000,CUdevice_v1,dev, unsigned int,flags);
DEF_FN(CUresult,cuDevicePrimaryCtxGetState_v7000,CUdevice_v1,dev, unsigned int*,flags, int*,active);
DEF_FN(CUresult,cuDevicePrimaryCtxReset_v11000,CUdevice_v1,dev);
DEF_FN(CUresult,cuDeviceGetExecAffinitySupport_v11040,int*,pi, CUexecAffinityType,type, CUdevice,dev);
DEF_FN(CUresult,cuCtxCreate_v3020,CUcontext*,pctx, unsigned int,flags, CUdevice_v1,dev);
DEF_FN(CUresult,cuCtxCreate_v11040,CUcontext*,pctx, CUexecAffinityParam*,paramsArray, int,numParams, unsigned int,flags, CUdevice_v1,dev);
DEF_FN(CUresult,cuCtxGetId_v12000,CUcontext,ctx, unsigned long long*,ctxId);
DEF_FN(CUresult,cuCtxDestroy_v4000,CUcontext,ctx);
DEF_FN(CUresult,cuCtxPushCurrent_v4000,CUcontext,ctx);
DEF_FN(CUresult,cuCtxPopCurrent_v4000,CUcontext*,pctx);
DEF_FN(CUresult,cuCtxSetCurrent_v4000,CUcontext,ctx);
DEF_FN(CUresult,cuCtxGetCurrent_v4000,CUcontext*,pctx);
DEF_FN(CUresult,cuCtxGetDevice_v2000,CUdevice_v1*,device);
DEF_FN(CUresult,cuCtxGetFlags_v7000,unsigned int*,flags);
DEF_FN(CUresult,cuCtxSetFlags_v12010,unsigned int,flags);
DEF_FN(CUresult,cuCtxSynchronize_v2000,void,);
DEF_FN(CUresult,cuCtxSetLimit_v3010,CUlimit,limit, size_t,value);
DEF_FN(CUresult,cuCtxGetLimit_v3010,size_t*,pvalue, CUlimit,limit);
DEF_FN(CUresult,cuCtxGetCacheConfig_v3020,CUfunc_cache*,pconfig);
DEF_FN(CUresult,cuCtxSetCacheConfig_v3020,CUfunc_cache,config);
DEF_FN(CUresult,cuCtxGetSharedMemConfig_v4020,CUsharedconfig*,pConfig);
DEF_FN(CUresult,cuCtxSetSharedMemConfig_v4020,CUsharedconfig,config);
DEF_FN(CUresult,cuCtxGetApiVersion_v3020,CUcontext,ctx, unsigned int*,version);
DEF_FN(CUresult,cuCtxGetStreamPriorityRange_v5050,int*,leastPriority, int*,greatestPriority);
DEF_FN(CUresult,cuCtxResetPersistingL2Cache_v11000,void,);
DEF_FN(CUresult,cuCtxAttach_v2000,CUcontext*,pctx, unsigned int,flags);
DEF_FN(CUresult,cuCtxDetach_v2000,CUcontext,ctx);
DEF_FN(CUresult,cuCtxGetExecAffinity_v11040,CUexecAffinityParam*,pExecAffinity, CUexecAffinityType,type);
DEF_FN(CUresult,cuModuleLoad_v2000,CUmodule*,module, const char*,fname);
DEF_FN(CUresult,cuModuleLoadData_v2000,CUmodule*,module, const void*,image);
DEF_FN(CUresult,cuModuleLoadDataEx_v2010,CUmodule*,module, const void*,image, unsigned int,numOptions, CUjit_option*,options, void**,optionValues);
DEF_FN(CUresult,cuModuleLoadFatBinary_v2000,CUmodule*,module, const void*,fatCubin);
DEF_FN(CUresult,cuModuleUnload_v2000,CUmodule,hmod);
DEF_FN(CUresult,cuModuleGetFunction_v2000,CUfunction*,hfunc, CUmodule,hmod, const char*,name);
DEF_FN(CUresult,cuModuleGetGlobal_v3020,CUdeviceptr_v2*,dptr, size_t*,bytes, CUmodule,hmod, const char*,name);
DEF_FN(CUresult,cuModuleGetTexRef_v2000,CUtexref*,pTexRef, CUmodule,hmod, const char*,name);
DEF_FN(CUresult,cuModuleGetSurfRef_v3000,CUsurfref*,pSurfRef, CUmodule,hmod, const char*,name);
DEF_FN(CUresult,cuModuleGetFunctionCount,unsigned int*,count, CUmodule,hmod);
DEF_FN(CUresult,cuModuleEnumerateFunctions,CUfunction*,functions, unsigned int,numFunctions, CUmodule,mod);
DEF_FN(CUresult,cuLinkCreate_v6050,unsigned int,numOptions, CUjit_option*,options, void**,optionValues, CUlinkState*,stateOut);
DEF_FN(CUresult,cuLinkAddData_v6050,CUlinkState,state, CUjitInputType,type, void*,data, size_t,size, const char*,name, unsigned int,numOptions, CUjit_option*,options, void**,optionValues);
DEF_FN(CUresult,cuLinkAddFile_v6050,CUlinkState,state, CUjitInputType,type, const char*,path, unsigned int,numOptions, CUjit_option*,options, void**,optionValues);
DEF_FN(CUresult,cuLinkComplete_v5050,CUlinkState,state, void**,cubinOut, size_t*,sizeOut);
DEF_FN(CUresult,cuLinkDestroy_v5050,CUlinkState,state);
DEF_FN(CUresult,cuMemGetInfo_v3020,size_t*,free, size_t*,total);
DEF_FN(CUresult,cuMemAlloc_v3020,CUdeviceptr_v2*,dptr, size_t,bytesize);
DEF_FN(CUresult,cuMemAllocPitch_v3020,CUdeviceptr_v2*,dptr, size_t*,pPitch, size_t,WidthInBytes, size_t,Height, unsigned int,ElementSizeBytes);
DEF_FN(CUresult,cuMemFree_v3020,CUdeviceptr_v2,dptr);
DEF_FN(CUresult,cuMemGetAddressRange_v3020,CUdeviceptr_v2*,pbase, size_t*,psize, CUdeviceptr_v2,dptr);
DEF_FN(CUresult,cuMemAllocHost_v3020,void**,pp, size_t,bytesize);
DEF_FN(CUresult,cuMemFreeHost_v2000,void*,p);
DEF_FN(CUresult,cuMemHostAlloc_v2020,void**,pp, size_t,bytesize, unsigned int,Flags);
DEF_FN(CUresult,cuMemHostGetDevicePointer_v3020,CUdeviceptr_v2*,pdptr, void*,p, unsigned int,Flags);
DEF_FN(CUresult,cuMemHostGetFlags_v2030,unsigned int*,pFlags, void*,p);
DEF_FN(CUresult,cuMemAllocManaged_v6000,CUdeviceptr_v2*,dptr, size_t,bytesize, unsigned int,flags);
DEF_FN(CUresult,cuDeviceGetByPCIBusId_v4010,CUdevice_v1*,dev, const char*,pciBusId);
DEF_FN(CUresult,cuDeviceGetPCIBusId_v4010,char*,pciBusId, int,len, CUdevice_v1,dev);
DEF_FN(CUresult,cuIpcGetEventHandle_v4010,CUipcEventHandle_v1*,pHandle, CUevent,event);
DEF_FN(CUresult,cuIpcOpenEventHandle_v4010,CUevent*,phEvent, CUipcEventHandle_v1,handle);
DEF_FN(CUresult,cuIpcGetMemHandle_v4010,CUipcMemHandle_v1*,pHandle, CUdeviceptr_v2,dptr);
DEF_FN(CUresult,cuIpcOpenMemHandle_v11000,CUdeviceptr_v2*,pdptr, CUipcMemHandle_v1,handle, unsigned int,Flags);
DEF_FN(CUresult,cuIpcCloseMemHandle_v4010,CUdeviceptr_v2,dptr);
DEF_FN(CUresult,cuMemHostRegister_v6050,void*,p, size_t,bytesize, unsigned int,Flags);
DEF_FN(CUresult,cuMemHostUnregister_v4000,void*,p);
DEF_FN(CUresult,cuMemcpy_v7000_ptds,CUdeviceptr_v2,dst, CUdeviceptr_v2,src, size_t,ByteCount);
DEF_FN(CUresult,cuMemcpyPeer_v7000_ptds,CUdeviceptr_v2,dstDevice, CUcontext,dstContext, CUdeviceptr_v2,srcDevice, CUcontext,srcContext, size_t,ByteCount);
DEF_FN(CUresult,cuMemcpyHtoD_v7000_ptds,CUdeviceptr_v2,dstDevice, const void*,srcHost, size_t,ByteCount);
DEF_FN(CUresult,cuMemcpyDtoH_v7000_ptds,void*,dstHost, CUdeviceptr_v2,srcDevice, size_t,ByteCount);
DEF_FN(CUresult,cuMemcpyDtoD_v7000_ptds,CUdeviceptr_v2,dstDevice, CUdeviceptr_v2,srcDevice, size_t,ByteCount);
DEF_FN(CUresult,cuMemcpyDtoA_v7000_ptds,CUarray,dstArray, size_t,dstOffset, CUdeviceptr_v2,srcDevice, size_t,ByteCount);
DEF_FN(CUresult,cuMemcpyAtoD_v7000_ptds,CUdeviceptr_v2,dstDevice, CUarray,srcArray, size_t,srcOffset, size_t,ByteCount);
DEF_FN(CUresult,cuMemcpyHtoA_v7000_ptds,CUarray,dstArray, size_t,dstOffset, const void*,srcHost, size_t,ByteCount);
DEF_FN(CUresult,cuMemcpyAtoH_v7000_ptds,void*,dstHost, CUarray,srcArray, size_t,srcOffset, size_t,ByteCount);
DEF_FN(CUresult,cuMemcpyAtoA_v7000_ptds,CUarray,dstArray, size_t,dstOffset, CUarray,srcArray, size_t,srcOffset, size_t,ByteCount);
DEF_FN(CUresult,cuMemcpy2D_v7000_ptds,const CUDA_MEMCPY2D_v2*,pCopy);
DEF_FN(CUresult,cuMemcpy2DUnaligned_v7000_ptds,const CUDA_MEMCPY2D_v2*,pCopy);
DEF_FN(CUresult,cuMemcpy3D_v7000_ptds,const CUDA_MEMCPY3D_v2*,pCopy);
DEF_FN(CUresult,cuMemcpy3DPeer_v7000_ptds,const CUDA_MEMCPY3D_PEER_v1*,pCopy);
DEF_FN(CUresult,cuMemcpyAsync_v7000_ptsz,CUdeviceptr_v2,dst, CUdeviceptr_v2,src, size_t,ByteCount, CUstream,hStream);
DEF_FN(CUresult,cuMemcpyPeerAsync_v7000_ptsz,CUdeviceptr_v2,dstDevice, CUcontext,dstContext, CUdeviceptr_v2,srcDevice, CUcontext,srcContext, size_t,ByteCount, CUstream,hStream);
DEF_FN(CUresult,cuMemcpyHtoDAsync_v7000_ptsz,CUdeviceptr_v2,dstDevice, const void*,srcHost, size_t,ByteCount, CUstream,hStream);
DEF_FN(CUresult,cuMemcpyDtoHAsync_v7000_ptsz,void*,dstHost, CUdeviceptr_v2,srcDevice, size_t,ByteCount, CUstream,hStream);
DEF_FN(CUresult,cuMemcpyDtoDAsync_v7000_ptsz,CUdeviceptr_v2,dstDevice, CUdeviceptr_v2,srcDevice, size_t,ByteCount, CUstream,hStream);
DEF_FN(CUresult,cuMemcpyHtoAAsync_v7000_ptsz,CUarray,dstArray, size_t,dstOffset, const void*,srcHost, size_t,ByteCount, CUstream,hStream);
DEF_FN(CUresult,cuMemcpyAtoHAsync_v7000_ptsz,void*,dstHost, CUarray,srcArray, size_t,srcOffset, size_t,ByteCount, CUstream,hStream);
DEF_FN(CUresult,cuMemcpy2DAsync_v7000_ptsz,const CUDA_MEMCPY2D_v2*,pCopy, CUstream,hStream);
DEF_FN(CUresult,cuMemcpy3DAsync_v7000_ptsz,const CUDA_MEMCPY3D_v2*,pCopy, CUstream,hStream);
DEF_FN(CUresult,cuMemcpy3DPeerAsync_v7000_ptsz,const CUDA_MEMCPY3D_PEER_v1*,pCopy, CUstream,hStream);
DEF_FN(CUresult,cuMemsetD8_v7000_ptds,CUdeviceptr_v2,dstDevice, unsigned char,uc, size_t,N);
DEF_FN(CUresult,cuMemsetD16_v7000_ptds,CUdeviceptr_v2,dstDevice, unsigned short,us, size_t,N);
DEF_FN(CUresult,cuMemsetD32_v7000_ptds,CUdeviceptr_v2,dstDevice, unsigned int,ui, size_t,N);
DEF_FN(CUresult,cuMemsetD2D8_v7000_ptds,CUdeviceptr_v2,dstDevice, size_t,dstPitch, unsigned char,uc, size_t,Width, size_t,Height);
DEF_FN(CUresult,cuMemsetD2D16_v7000_ptds,CUdeviceptr_v2,dstDevice, size_t,dstPitch, unsigned short,us, size_t,Width, size_t,Height);
DEF_FN(CUresult,cuMemsetD2D32_v7000_ptds,CUdeviceptr_v2,dstDevice, size_t,dstPitch, unsigned int,ui, size_t,Width, size_t,Height);
DEF_FN(CUresult,cuMemsetD8Async_v7000_ptsz,CUdeviceptr_v2,dstDevice, unsigned char,uc, size_t,N, CUstream,hStream);
DEF_FN(CUresult,cuMemsetD16Async_v7000_ptsz,CUdeviceptr_v2,dstDevice, unsigned short,us, size_t,N, CUstream,hStream);
DEF_FN(CUresult,cuMemsetD32Async_v7000_ptsz,CUdeviceptr_v2,dstDevice, unsigned int,ui, size_t,N, CUstream,hStream);
DEF_FN(CUresult,cuMemsetD2D8Async_v7000_ptsz,CUdeviceptr_v2,dstDevice, size_t,dstPitch, unsigned char,uc, size_t,Width, size_t,Height, CUstream,hStream);
DEF_FN(CUresult,cuMemsetD2D16Async_v7000_ptsz,CUdeviceptr_v2,dstDevice, size_t,dstPitch, unsigned short,us, size_t,Width, size_t,Height, CUstream,hStream);
DEF_FN(CUresult,cuMemsetD2D32Async_v7000_ptsz,CUdeviceptr_v2,dstDevice, size_t,dstPitch, unsigned int,ui, size_t,Width, size_t,Height, CUstream,hStream);
DEF_FN(CUresult,cuArrayCreate_v3020,CUarray*,pHandle, const CUDA_ARRAY_DESCRIPTOR_v2*,pAllocateArray);
DEF_FN(CUresult,cuArrayGetDescriptor_v3020,CUDA_ARRAY_DESCRIPTOR_v2*,pArrayDescriptor, CUarray,hArray);
DEF_FN(CUresult,cuArrayGetSparseProperties_v11010,CUDA_ARRAY_SPARSE_PROPERTIES_v1*,sparseProperties, CUarray,array);
DEF_FN(CUresult,cuMipmappedArrayGetSparseProperties_v11010,CUDA_ARRAY_SPARSE_PROPERTIES_v1*,sparseProperties, CUmipmappedArray,mipmap);
DEF_FN(CUresult,cuArrayGetMemoryRequirements_v11060,CUDA_ARRAY_MEMORY_REQUIREMENTS_v1*,memoryRequirements, CUarray,array, CUdevice,device);
DEF_FN(CUresult,cuMipmappedArrayGetMemoryRequirements_v11060,CUDA_ARRAY_MEMORY_REQUIREMENTS_v1*,memoryRequirements, CUmipmappedArray,mipmap, CUdevice,device);
DEF_FN(CUresult,cuArrayGetPlane_v11020,CUarray*,pPlaneArray, CUarray,hArray, unsigned int,planeIdx);
DEF_FN(CUresult,cuArrayDestroy_v2000,CUarray,hArray);
DEF_FN(CUresult,cuArray3DCreate_v3020,CUarray*,pHandle, const CUDA_ARRAY3D_DESCRIPTOR_v2*,pAllocateArray);
DEF_FN(CUresult,cuArray3DGetDescriptor_v3020,CUDA_ARRAY3D_DESCRIPTOR_v2*,pArrayDescriptor, CUarray,hArray);
DEF_FN(CUresult,cuMipmappedArrayCreate_v5000,CUmipmappedArray*,pHandle, const CUDA_ARRAY3D_DESCRIPTOR_v2*,pMipmappedArrayDesc, unsigned int,numMipmapLevels);
DEF_FN(CUresult,cuMipmappedArrayGetLevel_v5000,CUarray*,pLevelArray, CUmipmappedArray,hMipmappedArray, unsigned int,level);
DEF_FN(CUresult,cuMipmappedArrayDestroy_v5000,CUmipmappedArray,hMipmappedArray);
DEF_FN(CUresult,cuMemAddressReserve_v10020,CUdeviceptr_v2*,ptr, size_t,size, size_t,alignment, CUdeviceptr_v2,addr, unsigned long long,flags);
DEF_FN(CUresult,cuMemAddressFree_v10020,CUdeviceptr_v2,ptr, size_t,size);
DEF_FN(CUresult,cuMemCreate_v10020,CUmemGenericAllocationHandle_v1*,handle, size_t,size, const CUmemAllocationProp_v1*,prop, unsigned long long,flags);
DEF_FN(CUresult,cuMemRelease_v10020,CUmemGenericAllocationHandle_v1,handle);
DEF_FN(CUresult,cuMemMap_v10020,CUdeviceptr_v2,ptr, size_t,size, size_t,offset, CUmemGenericAllocationHandle_v1,handle, unsigned long long,flags);
DEF_FN(CUresult,cuMemMapArrayAsync_v11010_ptsz,CUarrayMapInfo_v1*,mapInfoList, unsigned int,count, CUstream,hStream);
DEF_FN(CUresult,cuMemUnmap_v10020,CUdeviceptr_v2,ptr, size_t,size);
DEF_FN(CUresult,cuMemSetAccess_v10020,CUdeviceptr_v2,ptr, size_t,size, const CUmemAccessDesc_v1*,desc, size_t,count);
DEF_FN(CUresult,cuMemGetAccess_v10020,unsigned long long*,flags, const CUmemLocation_v1*,location, CUdeviceptr_v2,ptr);
DEF_FN(CUresult,cuMemExportToShareableHandle_v10020,void*,shareableHandle, CUmemGenericAllocationHandle_v1,handle, CUmemAllocationHandleType,handleType, unsigned long long,flags);
DEF_FN(CUresult,cuMemImportFromShareableHandle_v10020,CUmemGenericAllocationHandle_v1*,handle, void*,osHandle, CUmemAllocationHandleType,shHandleType);
DEF_FN(CUresult,cuMemGetAllocationGranularity_v10020,size_t*,granularity, const CUmemAllocationProp_v1*,prop, CUmemAllocationGranularity_flags,option);
DEF_FN(CUresult,cuMemGetAllocationPropertiesFromHandle_v10020,CUmemAllocationProp_v1*,prop, CUmemGenericAllocationHandle_v1,handle);
DEF_FN(CUresult,cuMemRetainAllocationHandle_v11000,CUmemGenericAllocationHandle_v1*,handle, void*,addr);
DEF_FN(CUresult,cuMemFreeAsync_v11020_ptsz,CUdeviceptr_v2,dptr, CUstream,hStream);
DEF_FN(CUresult,cuMemAllocAsync_v11020_ptsz,CUdeviceptr_v2*,dptr, size_t,bytesize, CUstream,hStream);
DEF_FN(CUresult,cuMemPoolTrimTo_v11020,CUmemoryPool,pool, size_t,minBytesToKeep);
DEF_FN(CUresult,cuMemPoolSetAttribute_v11020,CUmemoryPool,pool, CUmemPool_attribute,attr, void*,value);
DEF_FN(CUresult,cuMemPoolGetAttribute_v11020,CUmemoryPool,pool, CUmemPool_attribute,attr, void*,value);
DEF_FN(CUresult,cuMemPoolSetAccess_v11020,CUmemoryPool,pool, const CUmemAccessDesc_v1*,map, size_t,count);
DEF_FN(CUresult,cuMemPoolGetAccess_v11020,CUmemAccess_flags*,flags, CUmemoryPool,memPool, CUmemLocation_v1*,location);
DEF_FN(CUresult,cuMemPoolCreate_v11020,CUmemoryPool*,pool, const CUmemPoolProps_v1*,poolProps);
DEF_FN(CUresult,cuMemPoolDestroy_v11020,CUmemoryPool,pool);
DEF_FN(CUresult,cuMemAllocFromPoolAsync_v11020_ptsz,CUdeviceptr_v2*,dptr, size_t,bytesize, CUmemoryPool,pool, CUstream,hStream);
DEF_FN(CUresult,cuMemPoolExportToShareableHandle_v11020,void*,handle_out, CUmemoryPool,pool, CUmemAllocationHandleType,handleType, unsigned long long,flags);
DEF_FN(CUresult,cuMemPoolImportFromShareableHandle_v11020,CUmemoryPool*,pool_out, void*,handle, CUmemAllocationHandleType,handleType, unsigned long long,flags);
DEF_FN(CUresult,cuMemPoolExportPointer_v11020,CUmemPoolPtrExportData_v1*,shareData_out, CUdeviceptr_v2,ptr);
DEF_FN(CUresult,cuMemPoolImportPointer_v11020,CUdeviceptr_v2*,ptr_out, CUmemoryPool,pool, CUmemPoolPtrExportData_v1*,shareData);
DEF_FN(CUresult,cuPointerGetAttribute_v4000,void*,data, CUpointer_attribute,attribute, CUdeviceptr_v2,ptr);
DEF_FN(CUresult,cuMemPrefetchAsync_v8000_ptsz,CUdeviceptr_v2,devPtr, size_t,count, CUdevice_v1,dstDevice, CUstream,hStream);
DEF_FN(CUresult,cuMemAdvise_v8000,CUdeviceptr_v2,devPtr, size_t,count, CUmem_advise,advice, CUdevice_v1,device);
DEF_FN(CUresult,cuMemAdvise_v12020,CUdeviceptr_v2,devPtr, size_t,count, CUmem_advise,advice, CUmemLocation_v1,location);
DEF_FN(CUresult,cuMemPrefetchAsync_v12020_ptsz,CUdeviceptr_v2,devPtr, size_t,count, CUmemLocation_v1,location, unsigned int,flags, CUstream,hStream);
DEF_FN(CUresult,cuMemRangeGetAttribute_v8000,void*,data, size_t,dataSize, CUmem_range_attribute,attribute, CUdeviceptr_v2,devPtr, size_t,count);
DEF_FN(CUresult,cuMemRangeGetAttributes_v8000,void**,data, size_t*,dataSizes, CUmem_range_attribute*,attributes, size_t,numAttributes, CUdeviceptr_v2,devPtr, size_t,count);
DEF_FN(CUresult,cuMulticastCreate_v12010,CUmemGenericAllocationHandle*,mcHandle, const CUmulticastObjectProp*,prop);
DEF_FN(CUresult,cuMulticastAddDevice_v12010,CUmemGenericAllocationHandle,mcHandle, CUdevice,dev);
DEF_FN(CUresult,cuMulticastBindMem_v12010,CUmemGenericAllocationHandle,mcHandle, size_t,mcOffset, CUmemGenericAllocationHandle,memHandle, size_t,memOffset, size_t,size, unsigned long long,flags);
DEF_FN(CUresult,cuMulticastBindAddr_v12010,CUmemGenericAllocationHandle,mcHandle, size_t,mcOffset, CUdeviceptr,memptr, size_t,size, unsigned long long,flags);
DEF_FN(CUresult,cuMulticastUnbind_v12010,CUmemGenericAllocationHandle,mcHandle, CUdevice,dev, size_t,mcOffset, size_t,size);
DEF_FN(CUresult,cuMulticastGetGranularity_v12010,size_t*,granularity, const CUmulticastObjectProp*,prop, CUmulticastGranularity_flags,option);
DEF_FN(CUresult,cuPointerSetAttribute_v6000,const void*,value, CUpointer_attribute,attribute, CUdeviceptr_v2,ptr);
DEF_FN(CUresult,cuPointerGetAttributes_v7000,unsigned int,numAttributes, CUpointer_attribute*,attributes, void**,data, CUdeviceptr_v2,ptr);
DEF_FN(CUresult,cuStreamCreate_v2000,CUstream*,phStream, unsigned int,Flags);
DEF_FN(CUresult,cuStreamCreateWithPriority_v5050,CUstream*,phStream, unsigned int,flags, int,priority);
DEF_FN(CUresult,cuStreamGetId_v12000,CUstream,hStream, unsigned long long*,streamId);
DEF_FN(CUresult,cuStreamGetId_v12000_ptsz,CUstream,hStream, unsigned long long*,streamId);
DEF_FN(CUresult,cuStreamGetPriority_v7000_ptsz,CUstream,hStream, int*,priority);
DEF_FN(CUresult,cuStreamGetFlags_v7000_ptsz,CUstream,hStream, unsigned int*,flags);
DEF_FN(CUresult,cuStreamGetCtx_v9020_ptsz,CUstream,hStream, CUcontext*,pctx);
DEF_FN(CUresult,cuStreamWaitEvent_v7000_ptsz,CUstream,hStream, CUevent,hEvent, unsigned int,Flags);
DEF_FN(CUresult,cuStreamAddCallback_v7000_ptsz,CUstream,hStream, CUstreamCallback,callback, void*,userData, unsigned int,flags);
DEF_FN(CUresult,cuStreamBeginCapture_v10010_ptsz,CUstream,hStream, CUstreamCaptureMode,mode);
DEF_FN(CUresult,cuStreamBeginCaptureToGraph_v12030_ptsz,CUstream,hStream, CUgraph,hGraph, const CUgraphNode*,dependencies, const CUgraphEdgeData*,dependencyData, size_t,numDependencies, CUstreamCaptureMode,mode);
DEF_FN(CUresult,cuThreadExchangeStreamCaptureMode_v10010,CUstreamCaptureMode*,mode);
DEF_FN(CUresult,cuStreamEndCapture_v10000_ptsz,CUstream,hStream, CUgraph*,phGraph);
DEF_FN(CUresult,cuStreamIsCapturing_v10000_ptsz,CUstream,hStream, CUstreamCaptureStatus*,captureStatus);
DEF_FN(CUresult,cuStreamGetCaptureInfo_v10010_ptsz,CUstream,hStream, CUstreamCaptureStatus*,captureStatus_out, cuuint64_t*,id_out);
DEF_FN(CUresult,cuStreamGetCaptureInfo_v11030_ptsz,CUstream,hStream, CUstreamCaptureStatus*,captureStatus_out, cuuint64_t*,id_out, CUgraph*,graph_out, const CUgraphNode**,dependencies_out, size_t*,numDependencies_out);
DEF_FN(CUresult,cuStreamGetCaptureInfo_v12030_ptsz,CUstream,hStream, CUstreamCaptureStatus*,captureStatus_out, cuuint64_t*,id_out, CUgraph*,graph_out, const CUgraphNode**,dependencies_out, const CUgraphEdgeData**,edgeData_out, size_t*,numDependencies_out);
DEF_FN(CUresult,cuStreamUpdateCaptureDependencies_v11030_ptsz,CUstream,hStream, CUgraphNode*,dependencies, size_t,numDependencies, unsigned int,flags);
DEF_FN(CUresult,cuStreamUpdateCaptureDependencies_v12030_ptsz,CUstream,hStream, CUgraphNode*,dependencies, const CUgraphEdgeData*,dependencyData, size_t,numDependencies, unsigned int,flags);
DEF_FN(CUresult,cuStreamAttachMemAsync_v7000_ptsz,CUstream,hStream, CUdeviceptr_v2,dptr, size_t,length, unsigned int,flags);
DEF_FN(CUresult,cuStreamQuery_v7000_ptsz,CUstream,hStream);
DEF_FN(CUresult,cuStreamSynchronize_v7000_ptsz,CUstream,hStream);
DEF_FN(CUresult,cuStreamDestroy_v4000,CUstream,hStream);
DEF_FN(CUresult,cuStreamCopyAttributes_v11000_ptsz,CUstream,dst, CUstream,src);
DEF_FN(CUresult,cuStreamGetAttribute_v11000_ptsz,CUstream,hStream, CUstreamAttrID,attr, CUstreamAttrValue_v1*,value_out);
DEF_FN(CUresult,cuStreamSetAttribute_v11000_ptsz,CUstream,hStream, CUstreamAttrID,attr, const CUstreamAttrValue_v1*,value);
DEF_FN(CUresult,cuEventCreate_v2000,CUevent*,phEvent, unsigned int,Flags);
DEF_FN(CUresult,cuEventRecord_v7000_ptsz,CUevent,hEvent, CUstream,hStream);
DEF_FN(CUresult,cuEventRecordWithFlags_v11010_ptsz,CUevent,hEvent, CUstream,hStream, unsigned int,flags);
DEF_FN(CUresult,cuEventQuery_v2000,CUevent,hEvent);
DEF_FN(CUresult,cuEventSynchronize_v2000,CUevent,hEvent);
DEF_FN(CUresult,cuEventDestroy_v4000,CUevent,hEvent);
DEF_FN(CUresult,cuEventElapsedTime_v2000,float*,pMilliseconds, CUevent,hStart, CUevent,hEnd);
DEF_FN(CUresult,cuImportExternalMemory_v10000,CUexternalMemory*,extMem_out, const CUDA_EXTERNAL_MEMORY_HANDLE_DESC_v1*,memHandleDesc);
DEF_FN(CUresult,cuExternalMemoryGetMappedBuffer_v10000,CUdeviceptr_v2*,devPtr, CUexternalMemory,extMem, const CUDA_EXTERNAL_MEMORY_BUFFER_DESC_v1*,bufferDesc);
DEF_FN(CUresult,cuExternalMemoryGetMappedMipmappedArray_v10000,CUmipmappedArray*,mipmap, CUexternalMemory,extMem, const CUDA_EXTERNAL_MEMORY_MIPMAPPED_ARRAY_DESC_v1*,mipmapDesc);
DEF_FN(CUresult,cuDestroyExternalMemory_v10000,CUexternalMemory,extMem);
DEF_FN(CUresult,cuImportExternalSemaphore_v10000,CUexternalSemaphore*,extSem_out, const CUDA_EXTERNAL_SEMAPHORE_HANDLE_DESC_v1*,semHandleDesc);
DEF_FN(CUresult,cuSignalExternalSemaphoresAsync_v10000_ptsz,const CUexternalSemaphore*,extSemArray, const CUDA_EXTERNAL_SEMAPHORE_SIGNAL_PARAMS_v1*,paramsArray, unsigned int,numExtSems, CUstream,stream);
DEF_FN(CUresult,cuWaitExternalSemaphoresAsync_v10000_ptsz,const CUexternalSemaphore*,extSemArray, const CUDA_EXTERNAL_SEMAPHORE_WAIT_PARAMS_v1*,paramsArray, unsigned int,numExtSems, CUstream,stream);
DEF_FN(CUresult,cuDestroyExternalSemaphore_v10000,CUexternalSemaphore,extSem);
DEF_FN(CUresult,cuStreamWaitValue32_v8000_ptsz,CUstream,stream, CUdeviceptr_v2,addr, cuuint32_t,value, unsigned int,flags);
DEF_FN(CUresult,cuStreamWaitValue64_v9000_ptsz,CUstream,stream, CUdeviceptr_v2,addr, cuuint64_t,value, unsigned int,flags);
DEF_FN(CUresult,cuStreamWriteValue32_v8000_ptsz,CUstream,stream, CUdeviceptr_v2,addr, cuuint32_t,value, unsigned int,flags);
DEF_FN(CUresult,cuStreamWriteValue64_v9000_ptsz,CUstream,stream, CUdeviceptr_v2,addr, cuuint64_t,value, unsigned int,flags);
DEF_FN(CUresult,cuStreamBatchMemOp_v8000_ptsz,CUstream,stream, unsigned int,count, CUstreamBatchMemOpParams_v1*,paramArray, unsigned int,flags);
DEF_FN(CUresult,cuStreamWaitValue32_v11070_ptsz,CUstream,stream, CUdeviceptr_v2,addr, cuuint32_t,value, unsigned int,flags);
DEF_FN(CUresult,cuStreamWaitValue64_v11070_ptsz,CUstream,stream, CUdeviceptr_v2,addr, cuuint64_t,value, unsigned int,flags);
DEF_FN(CUresult,cuStreamWriteValue32_v11070_ptsz,CUstream,stream, CUdeviceptr_v2,addr, cuuint32_t,value, unsigned int,flags);
DEF_FN(CUresult,cuStreamWriteValue64_v11070_ptsz,CUstream,stream, CUdeviceptr_v2,addr, cuuint64_t,value, unsigned int,flags);
DEF_FN(CUresult,cuStreamBatchMemOp_v11070_ptsz,CUstream,stream, unsigned int,count, CUstreamBatchMemOpParams*,paramArray, unsigned int,flags);
DEF_FN(CUresult,cuFuncGetAttribute_v2020,int*,pi, CUfunction_attribute,attrib, CUfunction,hfunc);
DEF_FN(CUresult,cuFuncSetAttribute_v9000,CUfunction,hfunc, CUfunction_attribute,attrib, int,value);
DEF_FN(CUresult,cuFuncSetCacheConfig_v3000,CUfunction,hfunc, CUfunc_cache,config);
DEF_FN(CUresult,cuFuncSetSharedMemConfig_v4020,CUfunction,hfunc, CUsharedconfig,config);
DEF_FN(CUresult,cuFuncGetName_v12030,const char**,name, CUfunction,hfunc);
DEF_FN(CUresult,cuFuncGetParamInfo_v12040,CUfunction,func, size_t,paramIndex, size_t*,paramOffset, size_t*,paramSize);
DEF_FN(CUresult,cuFuncIsLoaded_v12040,CUfunctionLoadingState*,state, CUfunction,hfunc);
DEF_FN(CUresult,cuFuncLoad_v12040,CUfunction,hfunc);
DEF_FN(CUresult,cuLaunchKernel_v7000_ptsz,CUfunction,f, unsigned int,gridDimX, unsigned int,gridDimY, unsigned int,gridDimZ, unsigned int,blockDimX, unsigned int,blockDimY, unsigned int,blockDimZ, unsigned int,sharedMemBytes, CUstream,hStream, void**,kernelParams, void**,extra);
DEF_FN(CUresult,cuLaunchKernelEx_v11060_ptsz,const CUlaunchConfig*,config, CUfunction,f, void**,kernelParams, void**,extra);
DEF_FN(CUresult,cuLaunchCooperativeKernel_v9000_ptsz,CUfunction,f, unsigned int,gridDimX, unsigned int,gridDimY, unsigned int,gridDimZ, unsigned int,blockDimX, unsigned int,blockDimY, unsigned int,blockDimZ, unsigned int,sharedMemBytes, CUstream,hStream, void**,kernelParams);
DEF_FN(CUresult,cuLaunchCooperativeKernelMultiDevice_v9000,CUDA_LAUNCH_PARAMS_v1*,launchParamsList, unsigned int,numDevices, unsigned int,flags);
DEF_FN(CUresult,cuLaunchHostFunc_v10000_ptsz,CUstream,hStream, CUhostFn,fn, void*,userData);
DEF_FN(CUresult,cuFuncSetBlockShape_v2000,CUfunction,hfunc, int,x, int,y, int,z);
DEF_FN(CUresult,cuFuncSetSharedSize_v2000,CUfunction,hfunc, unsigned int,bytes);
DEF_FN(CUresult,cuParamSetSize_v2000,CUfunction,hfunc, unsigned int,numbytes);
DEF_FN(CUresult,cuParamSeti_v2000,CUfunction,hfunc, int,offset, unsigned int,value);
DEF_FN(CUresult,cuParamSetf_v2000,CUfunction,hfunc, int,offset, float,value);
DEF_FN(CUresult,cuParamSetv_v2000,CUfunction,hfunc, int,offset, void*,ptr, unsigned int,numbytes);
DEF_FN(CUresult,cuLaunch_v2000,CUfunction,f);
DEF_FN(CUresult,cuLaunchGrid_v2000,CUfunction,f, int,grid_width, int,grid_height);
DEF_FN(CUresult,cuLaunchGridAsync_v2000,CUfunction,f, int,grid_width, int,grid_height, CUstream,hStream);
DEF_FN(CUresult,cuParamSetTexRef_v2000,CUfunction,hfunc, int,texunit, CUtexref,hTexRef);
DEF_FN(CUresult,cuGraphCreate_v10000,CUgraph*,phGraph, unsigned int,flags);
DEF_FN(CUresult,cuGraphAddKernelNode_v10000,CUgraphNode*,phGraphNode, CUgraph,hGraph, const CUgraphNode*,dependencies, size_t,numDependencies, const CUDA_KERNEL_NODE_PARAMS_v1*,nodeParams);
DEF_FN(CUresult,cuGraphKernelNodeGetParams_v10000,CUgraphNode,hNode, CUDA_KERNEL_NODE_PARAMS_v1*,nodeParams);
DEF_FN(CUresult,cuGraphKernelNodeSetParams_v10000,CUgraphNode,hNode, const CUDA_KERNEL_NODE_PARAMS_v1*,nodeParams);
DEF_FN(CUresult,cuGraphAddKernelNode_v12000,CUgraphNode*,phGraphNode, CUgraph,hGraph, const CUgraphNode*,dependencies, size_t,numDependencies, const CUDA_KERNEL_NODE_PARAMS_v2*,nodeParams);
DEF_FN(CUresult,cuGraphKernelNodeGetParams_v12000,CUgraphNode,hNode, CUDA_KERNEL_NODE_PARAMS_v2*,nodeParams);
DEF_FN(CUresult,cuGraphKernelNodeSetParams_v12000,CUgraphNode,hNode, const CUDA_KERNEL_NODE_PARAMS_v2*,nodeParams);
DEF_FN(CUresult,cuGraphAddMemcpyNode_v10000,CUgraphNode*,phGraphNode, CUgraph,hGraph, const CUgraphNode*,dependencies, size_t,numDependencies, const CUDA_MEMCPY3D_v2*,copyParams, CUcontext,ctx);
DEF_FN(CUresult,cuGraphMemcpyNodeGetParams_v10000,CUgraphNode,hNode, CUDA_MEMCPY3D_v2*,nodeParams);
DEF_FN(CUresult,cuGraphMemcpyNodeSetParams_v10000,CUgraphNode,hNode, const CUDA_MEMCPY3D_v2*,nodeParams);
DEF_FN(CUresult,cuGraphAddMemsetNode_v10000,CUgraphNode*,phGraphNode, CUgraph,hGraph, const CUgraphNode*,dependencies, size_t,numDependencies, const CUDA_MEMSET_NODE_PARAMS_v1*,memsetParams, CUcontext,ctx);
DEF_FN(CUresult,cuGraphMemsetNodeGetParams_v10000,CUgraphNode,hNode, CUDA_MEMSET_NODE_PARAMS_v1*,nodeParams);
DEF_FN(CUresult,cuGraphMemsetNodeSetParams_v10000,CUgraphNode,hNode, const CUDA_MEMSET_NODE_PARAMS_v1*,nodeParams);
DEF_FN(CUresult,cuGraphAddHostNode_v10000,CUgraphNode*,phGraphNode, CUgraph,hGraph, const CUgraphNode*,dependencies, size_t,numDependencies, const CUDA_HOST_NODE_PARAMS_v1*,nodeParams);
DEF_FN(CUresult,cuGraphHostNodeGetParams_v10000,CUgraphNode,hNode, CUDA_HOST_NODE_PARAMS_v1*,nodeParams);
DEF_FN(CUresult,cuGraphHostNodeSetParams_v10000,CUgraphNode,hNode, const CUDA_HOST_NODE_PARAMS_v1*,nodeParams);
DEF_FN(CUresult,cuGraphAddChildGraphNode_v10000,CUgraphNode*,phGraphNode, CUgraph,hGraph, const CUgraphNode*,dependencies, size_t,numDependencies, CUgraph,childGraph);
DEF_FN(CUresult,cuGraphChildGraphNodeGetGraph_v10000,CUgraphNode,hNode, CUgraph*,phGraph);
DEF_FN(CUresult,cuGraphAddEmptyNode_v10000,CUgraphNode*,phGraphNode, CUgraph,hGraph, const CUgraphNode*,dependencies, size_t,numDependencies);
DEF_FN(CUresult,cuGraphAddEventRecordNode_v11010,CUgraphNode*,phGraphNode, CUgraph,hGraph, const CUgraphNode*,dependencies, size_t,numDependencies, CUevent,event);
DEF_FN(CUresult,cuGraphEventRecordNodeGetEvent_v11010,CUgraphNode,hNode, CUevent*,event_out);
DEF_FN(CUresult,cuGraphEventRecordNodeSetEvent_v11010,CUgraphNode,hNode, CUevent,event);
DEF_FN(CUresult,cuGraphAddEventWaitNode_v11010,CUgraphNode*,phGraphNode, CUgraph,hGraph, const CUgraphNode*,dependencies, size_t,numDependencies, CUevent,event);
DEF_FN(CUresult,cuGraphEventWaitNodeGetEvent_v11010,CUgraphNode,hNode, CUevent*,event_out);
DEF_FN(CUresult,cuGraphEventWaitNodeSetEvent_v11010,CUgraphNode,hNode, CUevent,event);
DEF_FN(CUresult,cuGraphAddExternalSemaphoresSignalNode_v11020,CUgraphNode*,phGraphNode, CUgraph,hGraph, const CUgraphNode*,dependencies, size_t,numDependencies, const CUDA_EXT_SEM_SIGNAL_NODE_PARAMS_v1*,nodeParams);
DEF_FN(CUresult,cuGraphExternalSemaphoresSignalNodeGetParams_v11020,CUgraphNode,hNode, CUDA_EXT_SEM_SIGNAL_NODE_PARAMS_v1*,params_out);
DEF_FN(CUresult,cuGraphExternalSemaphoresSignalNodeSetParams_v11020,CUgraphNode,hNode, const CUDA_EXT_SEM_SIGNAL_NODE_PARAMS_v1*,nodeParams);
DEF_FN(CUresult,cuGraphAddExternalSemaphoresWaitNode_v11020,CUgraphNode*,phGraphNode, CUgraph,hGraph, const CUgraphNode*,dependencies, size_t,numDependencies, const CUDA_EXT_SEM_WAIT_NODE_PARAMS_v1*,nodeParams);
DEF_FN(CUresult,cuGraphExternalSemaphoresWaitNodeGetParams_v11020,CUgraphNode,hNode, CUDA_EXT_SEM_WAIT_NODE_PARAMS_v1*,params_out);
DEF_FN(CUresult,cuGraphExternalSemaphoresWaitNodeSetParams_v11020,CUgraphNode,hNode, const CUDA_EXT_SEM_WAIT_NODE_PARAMS_v1*,nodeParams);
DEF_FN(CUresult,cuGraphAddBatchMemOpNode_v11070,CUgraphNode*,phGraphNode, CUgraph,hGraph, const CUgraphNode*,dependencies, size_t,numDependencies, const CUDA_BATCH_MEM_OP_NODE_PARAMS*,nodeParams);
DEF_FN(CUresult,cuGraphBatchMemOpNodeGetParams_v11070,CUgraphNode,hNode, CUDA_BATCH_MEM_OP_NODE_PARAMS*,nodeParams_out);
DEF_FN(CUresult,cuGraphBatchMemOpNodeSetParams_v11070,CUgraphNode,hNode, const CUDA_BATCH_MEM_OP_NODE_PARAMS*,nodeParams);
DEF_FN(CUresult,cuGraphExecBatchMemOpNodeSetParams_v11070,CUgraphExec,graphExec, CUgraphNode,node, const CUDA_BATCH_MEM_OP_NODE_PARAMS*,nodeParams);
DEF_FN(CUresult,cuGraphClone_v10000,CUgraph*,phGraphClone, CUgraph,originalGraph);
DEF_FN(CUresult,cuGraphNodeFindInClone_v10000,CUgraphNode*,phNode, CUgraphNode,hOriginalNode, CUgraph,hClonedGraph);
DEF_FN(CUresult,cuGraphNodeGetType_v10000,CUgraphNode,hNode, CUgraphNodeType*,type);
DEF_FN(CUresult,cuGraphGetNodes_v10000,CUgraph,hGraph, CUgraphNode*,nodes, size_t*,numNodes);
DEF_FN(CUresult,cuGraphGetRootNodes_v10000,CUgraph,hGraph, CUgraphNode*,rootNodes, size_t*,numRootNodes);
DEF_FN(CUresult,cuGraphGetEdges_v10000,CUgraph,hGraph, CUgraphNode*,from, CUgraphNode*,to, size_t*,numEdges);
DEF_FN(CUresult,cuGraphGetEdges_v12030,CUgraph,hGraph, CUgraphNode*,from, CUgraphNode*,to, CUgraphEdgeData*,edgeData, size_t*,numEdges);
DEF_FN(CUresult,cuGraphNodeGetDependencies_v10000,CUgraphNode,hNode, CUgraphNode*,dependencies, size_t*,numDependencies);
DEF_FN(CUresult,cuGraphNodeGetDependencies_v12030,CUgraphNode,hNode, CUgraphNode*,dependencies, CUgraphEdgeData*,edgeData, size_t*,numDependencies);
DEF_FN(CUresult,cuGraphNodeGetDependentNodes_v10000,CUgraphNode,hNode, CUgraphNode*,dependentNodes, size_t*,numDependentNodes);
DEF_FN(CUresult,cuGraphNodeGetDependentNodes_v12030,CUgraphNode,hNode, CUgraphNode*,dependentNodes, CUgraphEdgeData*,edgeData, size_t*,numDependentNodes);
DEF_FN(CUresult,cuGraphAddDependencies_v10000,CUgraph,hGraph, const CUgraphNode*,from, const CUgraphNode*,to, size_t,numDependencies);
DEF_FN(CUresult,cuGraphAddDependencies_v12030,CUgraph,hGraph, const CUgraphNode*,from, const CUgraphNode*,to, const CUgraphEdgeData*,edgeData, size_t,numDependencies);
DEF_FN(CUresult,cuGraphRemoveDependencies_v10000,CUgraph,hGraph, const CUgraphNode*,from, const CUgraphNode*,to, size_t,numDependencies);
DEF_FN(CUresult,cuGraphRemoveDependencies_v12030,CUgraph,hGraph, const CUgraphNode*,from, const CUgraphNode*,to, const CUgraphEdgeData*,edgeData, size_t,numDependencies);
DEF_FN(CUresult,cuGraphDestroyNode_v10000,CUgraphNode,hNode);
DEF_FN(CUresult,cuGraphInstantiateWithFlags_v11040,CUgraphExec*,phGraphExec, CUgraph,hGraph, unsigned long long,flags);
DEF_FN(CUresult,cuGraphInstantiateWithParams_v12000_ptsz,CUgraphExec*,phGraphExec, CUgraph,hGraph, CUDA_GRAPH_INSTANTIATE_PARAMS*,instantiateParams);
DEF_FN(CUresult,cuGraphExecGetFlags_v12000,CUgraphExec,hGraphExec, cuuint64_t*,flags);
DEF_FN(CUresult,cuGraphExecKernelNodeSetParams_v10010,CUgraphExec,hGraphExec, CUgraphNode,hNode, const CUDA_KERNEL_NODE_PARAMS_v1*,nodeParams);
DEF_FN(CUresult,cuGraphExecKernelNodeSetParams_v12000,CUgraphExec,hGraphExec, CUgraphNode,hNode, const CUDA_KERNEL_NODE_PARAMS_v2*,nodeParams);
DEF_FN(CUresult,cuGraphExecMemcpyNodeSetParams_v10020,CUgraphExec,hGraphExec, CUgraphNode,hNode, const CUDA_MEMCPY3D_v2*,copyParams, CUcontext,ctx);
DEF_FN(CUresult,cuGraphExecMemsetNodeSetParams_v10020,CUgraphExec,hGraphExec, CUgraphNode,hNode, const CUDA_MEMSET_NODE_PARAMS_v1*,memsetParams, CUcontext,ctx);
DEF_FN(CUresult,cuGraphExecHostNodeSetParams_v10020,CUgraphExec,hGraphExec, CUgraphNode,hNode, const CUDA_HOST_NODE_PARAMS_v1*,nodeParams);
DEF_FN(CUresult,cuGraphExecChildGraphNodeSetParams_v11010,CUgraphExec,hGraphExec, CUgraphNode,hNode, CUgraph,childGraph);
DEF_FN(CUresult,cuGraphExecEventRecordNodeSetEvent_v11010,CUgraphExec,hGraphExec, CUgraphNode,hNode, CUevent,event);
DEF_FN(CUresult,cuGraphExecEventWaitNodeSetEvent_v11010,CUgraphExec,hGraphExec, CUgraphNode,hNode, CUevent,event);
DEF_FN(CUresult,cuGraphExecExternalSemaphoresSignalNodeSetParams_v11020,CUgraphExec,hGraphExec, CUgraphNode,hNode, const CUDA_EXT_SEM_SIGNAL_NODE_PARAMS_v1*,nodeParams);
DEF_FN(CUresult,cuGraphExecExternalSemaphoresWaitNodeSetParams_v11020,CUgraphExec,hGraphExec, CUgraphNode,hNode, const CUDA_EXT_SEM_WAIT_NODE_PARAMS_v1*,nodeParams);
DEF_FN(CUresult,cuGraphUpload_v11010_ptsz,CUgraphExec,hGraphExec, CUstream,hStream);
DEF_FN(CUresult,cuGraphLaunch_v10000_ptsz,CUgraphExec,hGraphExec, CUstream,hStream);
DEF_FN(CUresult,cuGraphExecDestroy_v10000,CUgraphExec,hGraphExec);
DEF_FN(CUresult,cuGraphDestroy_v10000,CUgraph,hGraph);
DEF_FN(CUresult,cuGraphExecUpdate_v10020,CUgraphExec,hGraphExec, CUgraph,hGraph, CUgraphNode*,hErrorNode_out, CUgraphExecUpdateResult*,updateResult_out);
DEF_FN(CUresult,cuGraphExecUpdate_v12000,CUgraphExec,hGraphExec, CUgraph,hGraph, CUgraphExecUpdateResultInfo*,resultInfo);
DEF_FN(CUresult,cuGraphKernelNodeCopyAttributes_v11000,CUgraphNode,dst, CUgraphNode,src);
DEF_FN(CUresult,cuGraphKernelNodeGetAttribute_v11000,CUgraphNode,hNode, CUkernelNodeAttrID,attr, CUkernelNodeAttrValue_v1*,value_out);
DEF_FN(CUresult,cuGraphKernelNodeSetAttribute_v11000,CUgraphNode,hNode, CUkernelNodeAttrID,attr, const CUkernelNodeAttrValue_v1*,value);
DEF_FN(CUresult,cuGraphDebugDotPrint_v11030,CUgraph,hGraph, const char*,path, unsigned int,flags);
DEF_FN(CUresult,cuGraphAddMemAllocNode_v11040,CUgraphNode*,phGraphNode, CUgraph,hGraph, const CUgraphNode*,dependencies, size_t,numDependencies, CUDA_MEM_ALLOC_NODE_PARAMS*,nodeParams);
DEF_FN(CUresult,cuGraphMemAllocNodeGetParams_v11040,CUgraphNode,hNode, CUDA_MEM_ALLOC_NODE_PARAMS*,params_out);
DEF_FN(CUresult,cuGraphAddMemFreeNode_v11040,CUgraphNode*,phGraphNode, CUgraph,hGraph, const CUgraphNode*,dependencies, size_t,numDependencies, CUdeviceptr,dptr);
DEF_FN(CUresult,cuGraphMemFreeNodeGetParams_v11040,CUgraphNode,hNode, CUdeviceptr*,dptr_out);
DEF_FN(CUresult,cuGraphNodeSetEnabled_v11060,CUgraphExec,hGraphExec, CUgraphNode,hNode, unsigned int,isEnabled);
DEF_FN(CUresult,cuGraphNodeGetEnabled_v11060,CUgraphExec,hGraphExec, CUgraphNode,hNode, unsigned int*,isEnabled);
DEF_FN(CUresult,cuGraphAddNode_v12020,CUgraphNode*,phGraphNode, CUgraph,hGraph, const CUgraphNode*,dependencies, size_t,numDependencies, CUgraphNodeParams*,nodeParams);
DEF_FN(CUresult,cuGraphAddNode_v12030,CUgraphNode*,phGraphNode, CUgraph,hGraph, const CUgraphNode*,dependencies, const CUgraphEdgeData*,dependencyData, size_t,numDependencies, CUgraphNodeParams*,nodeParams);
DEF_FN(CUresult,cuGraphNodeSetParams_v12020,CUgraphNode,hNode, CUgraphNodeParams*,nodeParams);
DEF_FN(CUresult,cuGraphExecNodeSetParams_v12020,CUgraphExec,hGraphExec, CUgraphNode,hNode, CUgraphNodeParams*,nodeParams);
DEF_FN(CUresult,cuGraphConditionalHandleCreate_v12030,CUgraphConditionalHandle*,pHandle_out, CUgraph,hGraph, CUcontext,ctx, unsigned int,defaultLaunchValue, unsigned int,flags);
DEF_FN(CUresult,cuDeviceGraphMemTrim_v11040,CUdevice,device);
DEF_FN(CUresult,cuDeviceGetGraphMemAttribute_v11040,CUdevice,device, CUgraphMem_attribute,attr, void*,value);
DEF_FN(CUresult,cuDeviceSetGraphMemAttribute_v11040,CUdevice,device, CUgraphMem_attribute,attr, void*,value);
DEF_FN(CUresult,cuOccupancyMaxActiveBlocksPerMultiprocessor_v6050,int*,numBlocks, CUfunction,func, int,blockSize, size_t,dynamicSMemSize);
DEF_FN(CUresult,cuOccupancyMaxActiveBlocksPerMultiprocessorWithFlags_v7000,int*,numBlocks, CUfunction,func, int,blockSize, size_t,dynamicSMemSize, unsigned int,flags);
DEF_FN(CUresult,cuOccupancyMaxPotentialBlockSize_v6050,int*,minGridSize, int*,blockSize, CUfunction,func, CUoccupancyB2DSize,blockSizeToDynamicSMemSize, size_t,dynamicSMemSize, int,blockSizeLimit);
DEF_FN(CUresult,cuOccupancyMaxPotentialBlockSizeWithFlags_v7000,int*,minGridSize, int*,blockSize, CUfunction,func, CUoccupancyB2DSize,blockSizeToDynamicSMemSize, size_t,dynamicSMemSize, int,blockSizeLimit, unsigned int,flags);
DEF_FN(CUresult,cuOccupancyAvailableDynamicSMemPerBlock_v10020,size_t*,dynamicSmemSize, CUfunction,func, int,numBlocks, int,blockSize);
DEF_FN(CUresult,cuOccupancyMaxPotentialClusterSize_v11070,int*,clusterSize, CUfunction,func, const CUlaunchConfig*,config);
DEF_FN(CUresult,cuOccupancyMaxActiveClusters_v11070,int*,numClusters, CUfunction,func, const CUlaunchConfig*,config);
DEF_FN(CUresult,cuTexRefSetArray_v2000,CUtexref,hTexRef, CUarray,hArray, unsigned int,Flags);
DEF_FN(CUresult,cuTexRefSetMipmappedArray_v5000,CUtexref,hTexRef, CUmipmappedArray,hMipmappedArray, unsigned int,Flags);
DEF_FN(CUresult,cuTexRefSetAddress_v3020,size_t*,ByteOffset, CUtexref,hTexRef, CUdeviceptr_v2,dptr, size_t,bytes);
DEF_FN(CUresult,cuTexRefSetAddress2D_v4010,CUtexref,hTexRef, const CUDA_ARRAY_DESCRIPTOR_v2*,desc, CUdeviceptr_v2,dptr, size_t,Pitch);
DEF_FN(CUresult,cuTexRefSetFormat_v2000,CUtexref,hTexRef, CUarray_format,fmt, int,NumPackedComponents);
DEF_FN(CUresult,cuTexRefSetAddressMode_v2000,CUtexref,hTexRef, int,dim, CUaddress_mode,am);
DEF_FN(CUresult,cuTexRefSetFilterMode_v2000,CUtexref,hTexRef, CUfilter_mode,fm);
DEF_FN(CUresult,cuTexRefSetMipmapFilterMode_v5000,CUtexref,hTexRef, CUfilter_mode,fm);
DEF_FN(CUresult,cuTexRefSetMipmapLevelBias_v5000,CUtexref,hTexRef, float,bias);
DEF_FN(CUresult,cuTexRefSetMipmapLevelClamp_v5000,CUtexref,hTexRef, float,minMipmapLevelClamp, float,maxMipmapLevelClamp);
DEF_FN(CUresult,cuTexRefSetMaxAnisotropy_v5000,CUtexref,hTexRef, unsigned int,maxAniso);
DEF_FN(CUresult,cuTexRefSetBorderColor_v8000,CUtexref,hTexRef, float*,pBorderColor);
DEF_FN(CUresult,cuTexRefSetFlags_v2000,CUtexref,hTexRef, unsigned int,Flags);
DEF_FN(CUresult,cuTexRefGetAddress_v3020,CUdeviceptr_v2*,pdptr, CUtexref,hTexRef);
DEF_FN(CUresult,cuTexRefGetArray_v2000,CUarray*,phArray, CUtexref,hTexRef);
DEF_FN(CUresult,cuTexRefGetMipmappedArray_v5000,CUmipmappedArray*,phMipmappedArray, CUtexref,hTexRef);
DEF_FN(CUresult,cuTexRefGetAddressMode_v2000,CUaddress_mode*,pam, CUtexref,hTexRef, int,dim);
DEF_FN(CUresult,cuTexRefGetFilterMode_v2000,CUfilter_mode*,pfm, CUtexref,hTexRef);
DEF_FN(CUresult,cuTexRefGetFormat_v2000,CUarray_format*,pFormat, int*,pNumChannels, CUtexref,hTexRef);
DEF_FN(CUresult,cuTexRefGetMipmapFilterMode_v5000,CUfilter_mode*,pfm, CUtexref,hTexRef);
DEF_FN(CUresult,cuTexRefGetMipmapLevelBias_v5000,float*,pbias, CUtexref,hTexRef);
DEF_FN(CUresult,cuTexRefGetMipmapLevelClamp_v5000,float*,pminMipmapLevelClamp, float*,pmaxMipmapLevelClamp, CUtexref,hTexRef);
DEF_FN(CUresult,cuTexRefGetMaxAnisotropy_v5000,int*,pmaxAniso, CUtexref,hTexRef);
DEF_FN(CUresult,cuTexRefGetBorderColor_v8000,float*,pBorderColor, CUtexref,hTexRef);
DEF_FN(CUresult,cuTexRefGetFlags_v2000,unsigned int*,pFlags, CUtexref,hTexRef);
DEF_FN(CUresult,cuTexRefCreate_v2000,CUtexref*,pTexRef);
DEF_FN(CUresult,cuTexRefDestroy_v2000,CUtexref,hTexRef);
DEF_FN(CUresult,cuSurfRefSetArray_v3000,CUsurfref,hSurfRef, CUarray,hArray, unsigned int,Flags);
DEF_FN(CUresult,cuSurfRefGetArray_v3000,CUarray*,phArray, CUsurfref,hSurfRef);
DEF_FN(CUresult,cuTexObjectCreate_v5000,CUtexObject_v1*,pTexObject, const CUDA_RESOURCE_DESC_v1*,pResDesc, const CUDA_TEXTURE_DESC_v1*,pTexDesc, const CUDA_RESOURCE_VIEW_DESC_v1*,pResViewDesc);
DEF_FN(CUresult,cuTexObjectDestroy_v5000,CUtexObject_v1,texObject);
DEF_FN(CUresult,cuTexObjectGetResourceDesc_v5000,CUDA_RESOURCE_DESC_v1*,pResDesc, CUtexObject_v1,texObject);
DEF_FN(CUresult,cuTexObjectGetTextureDesc_v5000,CUDA_TEXTURE_DESC_v1*,pTexDesc, CUtexObject_v1,texObject);
DEF_FN(CUresult,cuTexObjectGetResourceViewDesc_v5000,CUDA_RESOURCE_VIEW_DESC_v1*,pResViewDesc, CUtexObject_v1,texObject);
DEF_FN(CUresult,cuSurfObjectCreate_v5000,CUsurfObject_v1*,pSurfObject, const CUDA_RESOURCE_DESC_v1*,pResDesc);
DEF_FN(CUresult,cuSurfObjectDestroy_v5000,CUsurfObject_v1,surfObject);
DEF_FN(CUresult,cuSurfObjectGetResourceDesc_v5000,CUDA_RESOURCE_DESC_v1*,pResDesc, CUsurfObject_v1,surfObject);
DEF_FN(CUresult,cuTensorMapEncodeTiled_v12000,CUtensorMap*,tensorMap, CUtensorMapDataType,tensorDataType, cuuint32_t,tensorRank, void*,globalAddress, const cuuint64_t*,globalDim, const cuuint64_t*,globalStrides, const cuuint32_t*,boxDim, const cuuint32_t*,elementStrides, CUtensorMapInterleave,interleave, CUtensorMapSwizzle,swizzle, CUtensorMapL2promotion,l2Promotion, CUtensorMapFloatOOBfill,oobFill);
DEF_FN(CUresult,cuTensorMapEncodeIm2col_v12000,CUtensorMap*,tensorMap, CUtensorMapDataType,tensorDataType, cuuint32_t,tensorRank, void*,globalAddress, const cuuint64_t*,globalDim, const cuuint64_t*,globalStrides, const int*,pixelBoxLowerCorner, const int*,pixelBoxUpperCorner, cuuint32_t,channelsPerPixel, cuuint32_t,pixelsPerColumn, const cuuint32_t*,elementStrides, CUtensorMapInterleave,interleave, CUtensorMapSwizzle,swizzle, CUtensorMapL2promotion,l2Promotion, CUtensorMapFloatOOBfill,oobFill);
DEF_FN(CUresult,cuTensorMapReplaceAddress_v12000,CUtensorMap*,tensorMap, void*,globalAddress);
DEF_FN(CUresult,cuDeviceCanAccessPeer_v4000,int*,canAccessPeer, CUdevice_v1,dev, CUdevice_v1,peerDev);
DEF_FN(CUresult,cuCtxEnablePeerAccess_v4000,CUcontext,peerContext, unsigned int,Flags);
DEF_FN(CUresult,cuCtxDisablePeerAccess_v4000,CUcontext,peerContext);
DEF_FN(CUresult,cuDeviceGetP2PAttribute_v8000,int*,value, CUdevice_P2PAttribute,attrib, CUdevice_v1,srcDevice, CUdevice_v1,dstDevice);
DEF_FN(CUresult,cuGraphicsUnregisterResource_v3000,CUgraphicsResource,resource);
DEF_FN(CUresult,cuGraphicsSubResourceGetMappedArray_v3000,CUarray*,pArray, CUgraphicsResource,resource, unsigned int,arrayIndex, unsigned int,mipLevel);
DEF_FN(CUresult,cuGraphicsResourceGetMappedMipmappedArray_v5000,CUmipmappedArray*,pMipmappedArray, CUgraphicsResource,resource);
DEF_FN(CUresult,cuGraphicsResourceGetMappedPointer_v3020,CUdeviceptr_v2*,pDevPtr, size_t*,pSize, CUgraphicsResource,resource);
DEF_FN(CUresult,cuGraphicsResourceSetMapFlags_v6050,CUgraphicsResource,resource, unsigned int,flags);
DEF_FN(CUresult,cuGraphicsMapResources_v7000_ptsz,unsigned int,count, CUgraphicsResource*,resources, CUstream,hStream);
DEF_FN(CUresult,cuGraphicsUnmapResources_v7000_ptsz,unsigned int,count, CUgraphicsResource*,resources, CUstream,hStream);
DEF_FN(CUresult,cuGetExportTable_v3000,const void**,ppExportTable, const CUuuid*,pExportTableId);
DEF_FN(CUresult,cuFuncGetModule_v11000,CUmodule*,hmod, CUfunction,hfunc);
DEF_FN(CUresult,cuGetProcAddress_v11030,const char*,symbol, void**,pfn, int,driverVersion, cuuint64_t,flags);
DEF_FN(CUresult,cuGetProcAddress_v12000,const char*,symbol, void**,pfn, int,driverVersion, cuuint64_t,flags, CUdriverProcAddressQueryResult*,symbolFound);
DEF_FN(CUresult,cuMemcpyHtoD_v3020,CUdeviceptr_v2,dstDevice, const void*,srcHost, size_t,ByteCount);
DEF_FN(CUresult,cuMemcpyDtoH_v3020,void*,dstHost, CUdeviceptr_v2,srcDevice, size_t,ByteCount);
DEF_FN(CUresult,cuMemcpyDtoD_v3020,CUdeviceptr_v2,dstDevice, CUdeviceptr_v2,srcDevice, size_t,ByteCount);
DEF_FN(CUresult,cuMemcpyDtoA_v3020,CUarray,dstArray, size_t,dstOffset, CUdeviceptr_v2,srcDevice, size_t,ByteCount);
DEF_FN(CUresult,cuMemcpyAtoD_v3020,CUdeviceptr_v2,dstDevice, CUarray,srcArray, size_t,srcOffset, size_t,ByteCount);
DEF_FN(CUresult,cuMemcpyHtoA_v3020,CUarray,dstArray, size_t,dstOffset, const void*,srcHost, size_t,ByteCount);
DEF_FN(CUresult,cuMemcpyAtoH_v3020,void*,dstHost, CUarray,srcArray, size_t,srcOffset, size_t,ByteCount);
DEF_FN(CUresult,cuMemcpyAtoA_v3020,CUarray,dstArray, size_t,dstOffset, CUarray,srcArray, size_t,srcOffset, size_t,ByteCount);
DEF_FN(CUresult,cuMemcpyHtoAAsync_v3020,CUarray,dstArray, size_t,dstOffset, const void*,srcHost, size_t,ByteCount, CUstream,hStream);
DEF_FN(CUresult,cuMemcpyAtoHAsync_v3020,void*,dstHost, CUarray,srcArray, size_t,srcOffset, size_t,ByteCount, CUstream,hStream);
DEF_FN(CUresult,cuMemcpy2D_v3020,const CUDA_MEMCPY2D_v2*,pCopy);
DEF_FN(CUresult,cuMemcpy2DUnaligned_v3020,const CUDA_MEMCPY2D_v2*,pCopy);
DEF_FN(CUresult,cuMemcpy3D_v3020,const CUDA_MEMCPY3D_v2*,pCopy);
DEF_FN(CUresult,cuMemcpyHtoDAsync_v3020,CUdeviceptr_v2,dstDevice, const void*,srcHost, size_t,ByteCount, CUstream,hStream);
DEF_FN(CUresult,cuMemcpyDtoHAsync_v3020,void*,dstHost, CUdeviceptr_v2,srcDevice, size_t,ByteCount, CUstream,hStream);
DEF_FN(CUresult,cuMemcpyDtoDAsync_v3020,CUdeviceptr_v2,dstDevice, CUdeviceptr_v2,srcDevice, size_t,ByteCount, CUstream,hStream);
DEF_FN(CUresult,cuMemcpy2DAsync_v3020,const CUDA_MEMCPY2D_v2*,pCopy, CUstream,hStream);
DEF_FN(CUresult,cuMemcpy3DAsync_v3020,const CUDA_MEMCPY3D_v2*,pCopy, CUstream,hStream);
DEF_FN(CUresult,cuMemsetD8_v3020,CUdeviceptr_v2,dstDevice, unsigned char,uc, size_t,N);
DEF_FN(CUresult,cuMemsetD16_v3020,CUdeviceptr_v2,dstDevice, unsigned short,us, size_t,N);
DEF_FN(CUresult,cuMemsetD32_v3020,CUdeviceptr_v2,dstDevice, unsigned int,ui, size_t,N);
DEF_FN(CUresult,cuMemsetD2D8_v3020,CUdeviceptr_v2,dstDevice, size_t,dstPitch, unsigned char,uc, size_t,Width, size_t,Height);
DEF_FN(CUresult,cuMemsetD2D16_v3020,CUdeviceptr_v2,dstDevice, size_t,dstPitch, unsigned short,us, size_t,Width, size_t,Height);
DEF_FN(CUresult,cuMemsetD2D32_v3020,CUdeviceptr_v2,dstDevice, size_t,dstPitch, unsigned int,ui, size_t,Width, size_t,Height);
DEF_FN(CUresult,cuMemcpy_v4000,CUdeviceptr_v2,dst, CUdeviceptr_v2,src, size_t,ByteCount);
DEF_FN(CUresult,cuMemcpyAsync_v4000,CUdeviceptr_v2,dst, CUdeviceptr_v2,src, size_t,ByteCount, CUstream,hStream);
DEF_FN(CUresult,cuMemcpyPeer_v4000,CUdeviceptr_v2,dstDevice, CUcontext,dstContext, CUdeviceptr_v2,srcDevice, CUcontext,srcContext, size_t,ByteCount);
DEF_FN(CUresult,cuMemcpyPeerAsync_v4000,CUdeviceptr_v2,dstDevice, CUcontext,dstContext, CUdeviceptr_v2,srcDevice, CUcontext,srcContext, size_t,ByteCount, CUstream,hStream);
DEF_FN(CUresult,cuMemcpy3DPeer_v4000,const CUDA_MEMCPY3D_PEER_v1*,pCopy);
DEF_FN(CUresult,cuMemcpy3DPeerAsync_v4000,const CUDA_MEMCPY3D_PEER_v1*,pCopy, CUstream,hStream);
DEF_FN(CUresult,cuMemsetD8Async_v3020,CUdeviceptr_v2,dstDevice, unsigned char,uc, size_t,N, CUstream,hStream);
DEF_FN(CUresult,cuMemsetD16Async_v3020,CUdeviceptr_v2,dstDevice, unsigned short,us, size_t,N, CUstream,hStream);
DEF_FN(CUresult,cuMemsetD32Async_v3020,CUdeviceptr_v2,dstDevice, unsigned int,ui, size_t,N, CUstream,hStream);
DEF_FN(CUresult,cuMemsetD2D8Async_v3020,CUdeviceptr_v2,dstDevice, size_t,dstPitch, unsigned char,uc, size_t,Width, size_t,Height, CUstream,hStream);
DEF_FN(CUresult,cuMemsetD2D16Async_v3020,CUdeviceptr_v2,dstDevice, size_t,dstPitch, unsigned short,us, size_t,Width, size_t,Height, CUstream,hStream);
DEF_FN(CUresult,cuMemsetD2D32Async_v3020,CUdeviceptr_v2,dstDevice, size_t,dstPitch, unsigned int,ui, size_t,Width, size_t,Height, CUstream,hStream);
DEF_FN(CUresult,cuStreamGetPriority_v5050,CUstream,hStream, int*,priority);
DEF_FN(CUresult,cuStreamGetFlags_v5050,CUstream,hStream, unsigned int*,flags);
DEF_FN(CUresult,cuStreamGetCtx_v9020,CUstream,hStream, CUcontext*,pctx);
DEF_FN(CUresult,cuStreamWaitEvent_v3020,CUstream,hStream, CUevent,hEvent, unsigned int,Flags);
DEF_FN(CUresult,cuStreamAddCallback_v5000,CUstream,hStream, CUstreamCallback,callback, void*,userData, unsigned int,flags);
DEF_FN(CUresult,cuStreamAttachMemAsync_v6000,CUstream,hStream, CUdeviceptr_v2,dptr, size_t,length, unsigned int,flags);
DEF_FN(CUresult,cuStreamQuery_v2000,CUstream,hStream);
DEF_FN(CUresult,cuStreamSynchronize_v2000,CUstream,hStream);
DEF_FN(CUresult,cuEventRecord_v2000,CUevent,hEvent, CUstream,hStream);
DEF_FN(CUresult,cuEventRecordWithFlags_v11010,CUevent,hEvent, CUstream,hStream, unsigned int,flags);
DEF_FN(CUresult,cuLaunchKernel_v4000,CUfunction,f, unsigned int,gridDimX, unsigned int,gridDimY, unsigned int,gridDimZ, unsigned int,blockDimX, unsigned int,blockDimY, unsigned int,blockDimZ, unsigned int,sharedMemBytes, CUstream,hStream, void**,kernelParams, void**,extra);
DEF_FN(CUresult,cuLaunchKernelEx_v11060,const CUlaunchConfig*,config, CUfunction,f, void**,kernelParams, void**,extra);
DEF_FN(CUresult,cuLaunchHostFunc_v10000,CUstream,hStream, CUhostFn,fn, void*,userData);
DEF_FN(CUresult,cuGraphicsMapResources_v3000,unsigned int,count, CUgraphicsResource*,resources, CUstream,hStream);
DEF_FN(CUresult,cuGraphicsUnmapResources_v3000,unsigned int,count, CUgraphicsResource*,resources, CUstream,hStream);
DEF_FN(CUresult,cuStreamWriteValue32_v8000,CUstream,stream, CUdeviceptr_v2,addr, cuuint32_t,value, unsigned int,flags);
DEF_FN(CUresult,cuStreamWaitValue32_v8000,CUstream,stream, CUdeviceptr_v2,addr, cuuint32_t,value, unsigned int,flags);
DEF_FN(CUresult,cuStreamWriteValue64_v9000,CUstream,stream, CUdeviceptr_v2,addr, cuuint64_t,value, unsigned int,flags);
DEF_FN(CUresult,cuStreamWaitValue64_v9000,CUstream,stream, CUdeviceptr_v2,addr, cuuint64_t,value, unsigned int,flags);
DEF_FN(CUresult,cuStreamBatchMemOp_v8000,CUstream,stream, unsigned int,count, CUstreamBatchMemOpParams*,paramArray, unsigned int,flags);
DEF_FN(CUresult,cuStreamWriteValue32_v11070,CUstream,stream, CUdeviceptr_v2,addr, cuuint32_t,value, unsigned int,flags);
DEF_FN(CUresult,cuStreamWaitValue32_v11070,CUstream,stream, CUdeviceptr_v2,addr, cuuint32_t,value, unsigned int,flags);
DEF_FN(CUresult,cuStreamWriteValue64_v11070,CUstream,stream, CUdeviceptr_v2,addr, cuuint64_t,value, unsigned int,flags);
DEF_FN(CUresult,cuStreamWaitValue64_v11070,CUstream,stream, CUdeviceptr_v2,addr, cuuint64_t,value, unsigned int,flags);
DEF_FN(CUresult,cuStreamBatchMemOp_v11070,CUstream,stream, unsigned int,count, CUstreamBatchMemOpParams*,paramArray, unsigned int,flags);
DEF_FN(CUresult,cuMemPrefetchAsync_v8000,CUdeviceptr_v2,devPtr, size_t,count, CUdevice_v1,dstDevice, CUstream,hStream);
DEF_FN(CUresult,cuMemPrefetchAsync_v12020,CUdeviceptr_v2,devPtr, size_t,count, CUmemLocation_v1,location, unsigned int,flags, CUstream,hStream);
DEF_FN(CUresult,cuLaunchCooperativeKernel_v9000,CUfunction,f, unsigned int,gridDimX, unsigned int,gridDimY, unsigned int,gridDimZ, unsigned int,blockDimX, unsigned int,blockDimY, unsigned int,blockDimZ, unsigned int,sharedMemBytes, CUstream,hStream, void**,kernelParams);
DEF_FN(CUresult,cuSignalExternalSemaphoresAsync_v10000,const CUexternalSemaphore*,extSemArray, const CUDA_EXTERNAL_SEMAPHORE_SIGNAL_PARAMS_v1*,paramsArray, unsigned int,numExtSems, CUstream,stream);
DEF_FN(CUresult,cuWaitExternalSemaphoresAsync_v10000,const CUexternalSemaphore*,extSemArray, const CUDA_EXTERNAL_SEMAPHORE_WAIT_PARAMS_v1*,paramsArray, unsigned int,numExtSems, CUstream,stream);
DEF_FN(CUresult,cuStreamBeginCapture_v10010,CUstream,hStream, CUstreamCaptureMode,mode);
DEF_FN(CUresult,cuStreamBeginCaptureToGraph_v12030,CUstream,hStream, CUgraph,hGraph, const CUgraphNode*,dependencies, const CUgraphEdgeData*,dependencyData, size_t,numDependencies, CUstreamCaptureMode,mode);
DEF_FN(CUresult,cuStreamEndCapture_v10000,CUstream,hStream, CUgraph*,phGraph);
DEF_FN(CUresult,cuStreamIsCapturing_v10000,CUstream,hStream, CUstreamCaptureStatus*,captureStatus);
DEF_FN(CUresult,cuStreamGetCaptureInfo_v10010,CUstream,hStream, CUstreamCaptureStatus*,captureStatus_out, cuuint64_t*,id_out);
DEF_FN(CUresult,cuStreamGetCaptureInfo_v11030,CUstream,hStream, CUstreamCaptureStatus*,captureStatus_out, cuuint64_t*,id_out, CUgraph*,graph_out, const CUgraphNode**,dependencies_out, size_t*,numDependencies_out);
DEF_FN(CUresult,cuStreamGetCaptureInfo_v12030,CUstream,hStream, CUstreamCaptureStatus*,captureStatus_out, cuuint64_t*,id_out, CUgraph*,graph_out, const CUgraphNode**,dependencies_out, const CUgraphEdgeData**,edgeData_out, size_t*,numDependencies_out);
DEF_FN(CUresult,cuStreamUpdateCaptureDependencies_v11030,CUstream,hStream, CUgraphNode*,dependencies, size_t,numDependencies, unsigned int,flags);
DEF_FN(CUresult,cuStreamUpdateCaptureDependencies_v12030,CUstream,hStream, CUgraphNode*,dependencies, const CUgraphEdgeData*,dependencyData, size_t,numDependencies, unsigned int,flags);
DEF_FN(CUresult,cuGraphInstantiateWithParams_v12000,CUgraphExec*,phGraphExec, CUgraph,hGraph, CUDA_GRAPH_INSTANTIATE_PARAMS*,instantiateParams);
DEF_FN(CUresult,cuGraphUpload_v11010,CUgraphExec,hGraph, CUstream,hStream);
DEF_FN(CUresult,cuGraphLaunch_v10000,CUgraphExec,hGraph, CUstream,hStream);
DEF_FN(CUresult,cuStreamCopyAttributes_v11000,CUstream,dstStream, CUstream,srcStream);
DEF_FN(CUresult,cuStreamGetAttribute_v11000,CUstream,hStream, CUstreamAttrID,attr, CUstreamAttrValue_v1*,value);
DEF_FN(CUresult,cuStreamSetAttribute_v11000,CUstream,hStream, CUstreamAttrID,attr, const CUstreamAttrValue_v1*,param);
DEF_FN(CUresult,cuMemMapArrayAsync_v11010,CUarrayMapInfo_v1*,mapInfoList, unsigned int,count, CUstream,hStream);
DEF_FN(CUresult,cuMemFreeAsync_v11020,CUdeviceptr_v2,dptr, CUstream,hStream);
DEF_FN(CUresult,cuMemAllocAsync_v11020,CUdeviceptr_v2*,dptr, size_t,bytesize, CUstream,hStream);
DEF_FN(CUresult,cuMemAllocFromPoolAsync_v11020,CUdeviceptr_v2*,dptr, size_t,bytesize, CUmemoryPool,pool, CUstream,hStream);
DEF_FN(CUresult,cuFlushGPUDirectRDMAWrites_v11030,CUflushGPUDirectRDMAWritesTarget,target, CUflushGPUDirectRDMAWritesScope,scope);
DEF_FN(CUresult,cuUserObjectCreate_v11030,CUuserObject*,object_out, void*,ptr, CUhostFn,destroy, unsigned int,initialRefcount, unsigned int,flags);
DEF_FN(CUresult,cuUserObjectRetain_v11030,CUuserObject,object, unsigned int,count);
DEF_FN(CUresult,cuUserObjectRelease_v11030,CUuserObject,object, unsigned int,count);
DEF_FN(CUresult,cuGraphRetainUserObject_v11030,CUgraph,graph, CUuserObject,object, unsigned int,count, unsigned int,flags);
DEF_FN(CUresult,cuGraphReleaseUserObject_v11030,CUgraph,graph, CUuserObject,object, unsigned int,count);
DEF_FN(CUresult,cuModuleGetLoadingMode_v11070,CUmoduleLoadingMode*,mode);
DEF_FN(CUresult,cuMemGetHandleForAddressRange_v11070,void*,handle, CUdeviceptr,dptr, size_t,size, CUmemRangeHandleType,handleType, unsigned long long,flags);
DEF_FN(CUresult,cuLibraryLoadData_v12000,CUlibrary*,library, const void*,code, CUjit_option*,jitOptions, void**,jitOptionsValues, unsigned int,numJitOptions, CUlibraryOption*,libraryOptions, void**,libraryOptionValues, unsigned int,numLibraryOptions);
DEF_FN(CUresult,cuLibraryLoadFromFile_v12000,CUlibrary*,library, const char*,fileName, CUjit_option*,jitOptions, void**,jitOptionsValues, unsigned int,numJitOptions, CUlibraryOption*,libraryOptions, void**,libraryOptionValues, unsigned int,numLibraryOptions);
DEF_FN(CUresult,cuLibraryUnload_v12000,CUlibrary,library);
DEF_FN(CUresult,cuLibraryGetKernel_v12000,CUkernel*,pKernel, CUlibrary,library, const char*,name);
DEF_FN(CUresult,cuLibraryGetModule_v12000,CUmodule*,pMod, CUlibrary,library);
...
DEF_FN(CUresult,cuKernelGetFunction_v12000,CUfunction*,pFunc, CUkernel,kernel);
DEF_FN(CUresult,cuLibraryGetGlobal_v12000,CUdeviceptr*,dptr, size_t*,bytes, CUlibrary,library, const char*,name);
DEF_FN(CUresult,cuLibraryGetManaged_v12000,CUdeviceptr*,dptr, size_t*,bytes, CUlibrary,library, const char*,name);
DEF_FN(CUresult,cuKernelGetAttribute_v12000,int*,pi, CUfunction_attribute,attrib, CUkernel,kernel, CUdevice,dev);
DEF_FN(CUresult,cuKernelSetAttribute_v12000,CUfunction_attribute,attrib, int,val, CUkernel,kernel, CUdevice,dev);
DEF_FN(CUresult,cuKernelSetCacheConfig_v12000,CUkernel,kernel, CUfunc_cache,config, CUdevice,dev);
DEF_FN(CUresult,cuKernelGetName_v12030,const char**,name, CUkernel,hfunc);
DEF_FN(CUresult,cuKernelGetParamInfo_v12040,CUkernel,kernel, size_t,paramIndex, size_t*,paramOffset, size_t*,paramSize);
DEF_FN(CUresult,cuLibraryGetUnifiedFunction_v12000,void**,fptr, CUlibrary,library, const char*,symbol);
DEF_FN(CUresult,cuCoredumpGetAttribute_v12010,CUcoredumpSettings,get, void*,value, size_t*,size);
DEF_FN(CUresult,cuCoredumpGetAttributeGlobal_v12010,CUcoredumpSettings,get, void*,value, size_t*,size);
DEF_FN(CUresult,cuCoredumpSetAttribute_v12010,CUcoredumpSettings,set, void*,value, size_t*,size);
DEF_FN(CUresult,cuCoredumpSetAttributeGlobal_v12010,CUcoredumpSettings,set, void*,value, size_t*,size);
DEF_FN(CUresult,cuDeviceRegisterAsyncNotification_v12040,CUdevice,device, CUasyncCallback,callbackFunc, void*,userData, CUasyncCallbackHandle*,callback);
DEF_FN(CUresult,cuDeviceUnregisterAsyncNotification_v12040,CUdevice,device, CUasyncCallbackHandle,callback);
DEF_FN(CUresult,cuGreenCtxCreate_v12040,CUgreenCtx*,phCtx, CUdevResourceDesc,desc, CUdevice,dev, unsigned int,flags);
DEF_FN(CUresult,cuGreenCtxDestroy_v12040,CUgreenCtx,hCtx);
DEF_FN(CUresult,cuDeviceGetDevResource_v12040,CUdevice,dev, CUdevResource*,result, CUdevResourceType,type);
DEF_FN(CUresult,cuCtxGetDevResource_v12040,CUcontext,hCtx, CUdevResource*,result, CUdevResourceType,type);
DEF_FN(CUresult,cuGreenCtxGetDevResource_v12040,CUgreenCtx,hCtx, CUdevResource*,result, CUdevResourceType,type);
DEF_FN(CUresult,cuGreenCtxRecordEvent_v12040,CUgreenCtx,hCtx, CUevent,hEvent);
DEF_FN(CUresult,cuGreenCtxWaitEvent_v12040,CUgreenCtx,hCtx, CUevent,hEvent);
DEF_FN(CUresult,cuDevResourceGenerateDesc_v12040,CUdevResourceDesc*,phDesc, CUdevResource*,resources, unsigned int,nbResources);
DEF_FN(CUresult,cuDevSmResourceSplitByCount_v12040,CUdevResource*,result, unsigned int*,nbGroups, const CUdevResource*,input, CUdevResource*,remaining, unsigned int,useFlags, unsigned int,minCount);
DEF_FN(CUresult,cuStreamGetGreenCtx_v12040,CUstream,hStream, CUgreenCtx*,phCtx);
DEF_FN(CUresult,cuCtxFromGreenCtx_v12040,CUcontext*,pContext, CUgreenCtx,hCtx);
#if defined(__CUDA_API_VERSION_INTERNAL)
	DEF_FN(CUresult,cuMemHostRegister_v4000,void*,p, size_t,bytesize, unsigned int,Flags);
	DEF_FN(CUresult,cuGraphicsResourceSetMapFlags_v3000,CUgraphicsResource,resource, unsigned int,flags);
	DEF_FN(CUresult,cuLinkCreate_v5050,unsigned int,numOptions, CUjit_option*,options, void**,optionValues, CUlinkState*,stateOut);
	DEF_FN(CUresult,cuLinkAddData_v5050,CUlinkState,state, CUjitInputType,type, void*,data, size_t,size, const char*,name, unsigned int,numOptions, CUjit_option*,options, void**,optionValues);
	DEF_FN(CUresult,cuLinkAddFile_v5050,CUlinkState,state, CUjitInputType,type, const char*,path, unsigned int,numOptions, CUjit_option*,options, void**,optionValues);
	DEF_FN(CUresult,cuTexRefSetAddress2D_v3020,CUtexref,hTexRef, const CUDA_ARRAY_DESCRIPTOR_v2*,desc, CUdeviceptr_v2,dptr, size_t,Pitch);
	DEF_FN(CUresult,cuDeviceTotalMem_v2000,unsigned int*,bytes, CUdevice_v1,dev);
	DEF_FN(CUresult,cuCtxCreate_v2000,CUcontext*,pctx, unsigned int,flags, CUdevice_v1,dev);
	DEF_FN(CUresult,cuModuleGetGlobal_v2000,CUdeviceptr_v1*,dptr, unsigned int*,bytes, CUmodule,hmod, const char*,name);
	DEF_FN(CUresult,cuMemGetInfo_v2000,unsigned int*,free, unsigned int*,total);
	DEF_FN(CUresult,cuMemAlloc_v2000,CUdeviceptr_v1*,dptr, unsigned int,bytesize);
	DEF_FN(CUresult,cuMemAllocPitch_v2000,CUdeviceptr_v1*,dptr, unsigned int*,pPitch, unsigned int,WidthInBytes, unsigned int,Height, unsigned int,ElementSizeBytes);
	DEF_FN(CUresult,cuMemFree_v2000,CUdeviceptr_v1,dptr);
	DEF_FN(CUresult,cuMemGetAddressRange_v2000,CUdeviceptr_v1*,pbase, unsigned int*,psize, CUdeviceptr_v1,dptr);
	DEF_FN(CUresult,cuMemAllocHost_v2000,void**,pp, unsigned int,bytesize);
	DEF_FN(CUresult,cuMemHostGetDevicePointer_v2020,CUdeviceptr_v1*,pdptr, void*,p, unsigned int,Flags);
	DEF_FN(CUresult,cuMemcpyHtoD_v2000,CUdeviceptr_v1,dstDevice, const void*,srcHost, unsigned int,ByteCount);
	DEF_FN(CUresult,cuMemcpyDtoH_v2000,void*,dstHost, CUdeviceptr_v1,srcDevice, unsigned int,ByteCount);
	DEF_FN(CUresult,cuMemcpyDtoD_v2000,CUdeviceptr_v1,dstDevice, CUdeviceptr_v1,srcDevice, unsigned int,ByteCount);
	DEF_FN(CUresult,cuMemcpyDtoA_v2000,CUarray,dstArray, unsigned int,dstOffset, CUdeviceptr_v1,srcDevice, unsigned int,ByteCount);
	DEF_FN(CUresult,cuMemcpyAtoD_v2000,CUdeviceptr_v1,dstDevice, CUarray,srcArray, unsigned int,srcOffset, unsigned int,ByteCount);
	DEF_FN(CUresult,cuMemcpyHtoA_v2000,CUarray,dstArray, unsigned int,dstOffset, const void*,srcHost, unsigned int,ByteCount);
	DEF_FN(CUresult,cuMemcpyAtoH_v2000,void*,dstHost, CUarray,srcArray, unsigned int,srcOffset, unsigned int,ByteCount);
	DEF_FN(CUresult,cuMemcpyAtoA_v2000,CUarray,dstArray, unsigned int,dstOffset, CUarray,srcArray, unsigned int,srcOffset, unsigned int,ByteCount);
	DEF_FN(CUresult,cuMemcpyHtoAAsync_v2000,CUarray,dstArray, unsigned int,dstOffset, const void*,srcHost, unsigned int,ByteCount, CUstream,hStream);
	DEF_FN(CUresult,cuMemcpyAtoHAsync_v2000,void*,dstHost, CUarray,srcArray, unsigned int,srcOffset, unsigned int,ByteCount, CUstream,hStream);
	DEF_FN(CUresult,cuMemcpy2D_v2000,const CUDA_MEMCPY2D_v1*,pCopy);
	DEF_FN(CUresult,cuMemcpy2DUnaligned_v2000,const CUDA_MEMCPY2D_v1*,pCopy);
	DEF_FN(CUresult,cuMemcpy3D_v2000,const CUDA_MEMCPY3D_v1*,pCopy);
	DEF_FN(CUresult,cuMemcpyHtoDAsync_v2000,CUdeviceptr_v1,dstDevice, const void*,srcHost, unsigned int,ByteCount, CUstream,hStream);
	DEF_FN(CUresult,cuMemcpyDtoHAsync_v2000,void*,dstHost, CUdeviceptr_v1,srcDevice, unsigned int,ByteCount, CUstream,hStream);
	DEF_FN(CUresult,cuMemcpyDtoDAsync_v3000,CUdeviceptr_v1,dstDevice, CUdeviceptr_v1,srcDevice, unsigned int,ByteCount, CUstream,hStream);
	DEF_FN(CUresult,cuMemcpy2DAsync_v2000,const CUDA_MEMCPY2D_v1*,pCopy, CUstream,hStream);
	DEF_FN(CUresult,cuMemcpy3DAsync_v2000,const CUDA_MEMCPY3D_v1*,pCopy, CUstream,hStream);
	DEF_FN(CUresult,cuMemsetD8_v2000,CUdeviceptr_v1,dstDevice, unsigned char,uc, unsigned int,N);
	DEF_FN(CUresult,cuMemsetD16_v2000,CUdeviceptr_v1,dstDevice, unsigned short,us, unsigned int,N);
	DEF_FN(CUresult,cuMemsetD32_v2000,CUdeviceptr_v1,dstDevice, unsigned int,ui, unsigned int,N);
	DEF_FN(CUresult,cuMemsetD2D8_v2000,CUdeviceptr_v1,dstDevice, unsigned int,dstPitch, unsigned char,uc, unsigned int,Width, unsigned int,Height);
	DEF_FN(CUresult,cuMemsetD2D16_v2000,CUdeviceptr_v1,dstDevice, unsigned int,dstPitch, unsigned short,us, unsigned int,Width, unsigned int,Height);
	DEF_FN(CUresult,cuMemsetD2D32_v2000,CUdeviceptr_v1,dstDevice, unsigned int,dstPitch, unsigned int,ui, unsigned int,Width, unsigned int,Height);
	DEF_FN(CUresult,cuArrayCreate_v2000,CUarray*,pHandle, const CUDA_ARRAY_DESCRIPTOR_v1*,pAllocateArray);
	DEF_FN(CUresult,cuArrayGetDescriptor_v2000,CUDA_ARRAY_DESCRIPTOR_v1*,pArrayDescriptor, CUarray,hArray);
	DEF_FN(CUresult,cuArray3DCreate_v2000,CUarray*,pHandle, const CUDA_ARRAY3D_DESCRIPTOR_v1*,pAllocateArray);
	DEF_FN(CUresult,cuArray3DGetDescriptor_v2000,CUDA_ARRAY3D_DESCRIPTOR_v1*,pArrayDescriptor, CUarray,hArray);
	DEF_FN(CUresult,cuTexRefSetAddress_v2000,unsigned int*,ByteOffset, CUtexref,hTexRef, CUdeviceptr_v1,dptr, unsigned int,bytes);
	DEF_FN(CUresult,cuTexRefSetAddress2D_v2020,CUtexref,hTexRef, const CUDA_ARRAY_DESCRIPTOR_v1*,desc, CUdeviceptr_v1,dptr, unsigned int,Pitch);
	DEF_FN(CUresult,cuTexRefGetAddress_v2000,CUdeviceptr_v1*,pdptr, CUtexref,hTexRef);
	DEF_FN(CUresult,cuGraphicsResourceGetMappedPointer_v3000,CUdeviceptr_v1*,pDevPtr, unsigned int*,pSize, CUgraphicsResource,resource);
	DEF_FN(CUresult,cuCtxDestroy_v2000,CUcontext,ctx);
	DEF_FN(CUresult,cuCtxPopCurrent_v2000,CUcontext*,pctx);
	DEF_FN(CUresult,cuCtxPushCurrent_v2000,CUcontext,ctx);
	DEF_FN(CUresult,cuStreamDestroy_v2000,CUstream,hStream);
	DEF_FN(CUresult,cuEventDestroy_v2000,CUevent,hEvent);
	DEF_FN(CUresult,cuDevicePrimaryCtxRelease_v7000,CUdevice_v1,dev);
	DEF_FN(CUresult,cuDevicePrimaryCtxReset_v7000,CUdevice_v1,dev);
	DEF_FN(CUresult,cuDevicePrimaryCtxSetFlags_v7000,CUdevice_v1,dev, unsigned int,flags);
	DEF_FN(CUresult,cuStreamBeginCapture_v10000,CUstream,hStream);
	DEF_FN(CUresult,cuStreamBeginCapture_v10000_ptsz,CUstream,hStream);
	DEF_FN(CUresult,cuIpcOpenMemHandle_v4010,CUdeviceptr_v2*,pdptr, CUipcMemHandle_v1,handle, unsigned int,Flags);
	DEF_FN(CUresult,cuGraphInstantiate_v10000,CUgraphExec*,phGraphExec, CUgraph,hGraph, CUgraphNode*,phErrorNode, char*,logBuffer, size_t,bufferSize);
	DEF_FN(CUresult,cuGraphInstantiate_v11000,CUgraphExec*,phGraphExec, CUgraph,hGraph, CUgraphNode*,phErrorNode, char*,logBuffer, size_t,bufferSize);
#endif
